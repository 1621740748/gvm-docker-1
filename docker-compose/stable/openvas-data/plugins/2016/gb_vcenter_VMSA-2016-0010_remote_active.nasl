...
if(description)
{
  ...
  script_tag(name:"summary", value:"vCenter contain an HTTP header injection vulnerability due to lack of input validation.");
  ...
  script_mandatory_keys("vmware/vcenter/http/detected");
