...
if(description)
{
  ...
  script_version("2021-07-23T09:08:23+0000");
  script_tag(name:"last_modification", value:"2021-07-23 09:08:23 +0000 (Fri, 23 Jul 2021)");
...
foreach port( ports ) {
  ...
  foreach used_list( make_list( "short_transforms_list", "full_fransforms_list" ) ) {
    ...
    if( ! soc = isakmp_open_socket( port:port, proto:"udp" ) )
      continue;
