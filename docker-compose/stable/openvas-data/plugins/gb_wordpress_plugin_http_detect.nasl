...
if(description)
{
  ...
  script_tag(name:"last_modification", value:"2021-07-20 04:25:03 +0000 (Tue, 20 Jul 2021)");
...
"advanced-custom-fields-pro/readme.txt", "Advanced Custom Fields Pro#---#=== Advanced Custom Fields Pro#---#= ([0-9.]+) =#---#cpe:/a:elliot_condon:advanced-custom-fields-pro",
...
"contact-form-cfdb7/readme.txt", "Contact Form 7 Database Addon - CFDB7#---#=== Contact Form 7 Database Addon - CFDB7#---#Stable tag: ([0-9]+)#---#cpe:/a:contact_form_7_database_addon:contact_form_7_database_addon",
...
"elementor/readme.txt", "Elementor Website Builder#---#=== Elementor Website Builder#---#Stable tag: ([0-9.]+)#---#cpe:/a:elementor:website_builder",
...
"eps-301-redirects/readme.txt", "301 Redirects - Easy Redirect Manager#---#\*\*What is a 301 Redirect\?\*\*#---#Stable tag: ([0-9.]+)#---#cpe:/a:webfactory:eps-301-redirects",
...
"simple-301-redirects/readme.txt", "Simple 301 Redirects by BetterLinks#---#=== Simple 301 Redirects#---#Stable tag: ([0-9.]+)#---#cpe:/a:betterlinks:simple-301-redirects",
...
"woo-gutenberg-products-block/readme.txt", "WooCommerce Blocks#---#=== WooCommerce (Gutenberg|Blocks)#---#Stable tag: ([0-9.]+)#---#cpe:/a:claudiulodro:woocommerce_blocks",
...
"wordpress-popular-posts/readme.txt", "WordPress Popular Posts#---#=== WordPress Popular Posts#---#Stable tag: ([0-9.]+)#---#cpe:/a:cabrerahector:popular_posts",
