...
if(description)
{
  ...
  script_version("2021-02-08T14:00:12+0000");
  script_tag(name:"last_modification", value:"2021-02-08 14:00:12 +0000 (Mon, 08 Feb 2021)");
...
foreach key( key_list ) {
  foreach item( registry_enum_keys( key:key ) ) {
    ...
    # registry item 'DisplayVersion' has 9.80.0, 9.90.0 in it.
    if( regversion )
