...
if( ! is_pfsense ) {
  ...
  if( strlen( rls ) ) {
    ...
    os_rls = rls; # nb: Used later for SLES/SLED 15+
  }
...
if( rls =~ "suse linux enterprise desktop " || os_rls =~ "suse linux enterprise desktop " ) {
...
if( rls =~ "suse linux enterprise server " || os_rls =~ "suse linux enterprise server " ) {
