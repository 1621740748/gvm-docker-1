...
if(description)
{
  ...
  script_version("2021-06-17T13:42:24+0000");
  script_tag(name:"last_modification", value:"2021-06-17 13:42:24 +0000 (Thu, 17 Jun 2021)");
...
if( banner && banner =~ "^HPE? (OpenView Storage )?Data Protector" ) {
  ...
  set_kb_item( name:"hp_data_protector/" + port + "/version", value:version );
  set_kb_item( name:"hp_data_protector/" + port + "/build", value:build );
