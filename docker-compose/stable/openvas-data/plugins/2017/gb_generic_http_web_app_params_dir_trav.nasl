...
if(description)
{
  ...
  script_version("2021-07-28T13:44:26+0000");
  script_tag(name:"cvss_base", value:"10.0");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:C/I:C/A:C");
  script_tag(name:"last_modification", value:"2021-07-28 13:44:26 +0000 (Wed, 28 Jul 2021)");
  script_tag(name:"creation_date", value:"2017-09-26 10:00:00 +0200 (Tue, 26 Sep 2017)");

  # Currently commented out as our automatic CVSS correction would raise the CVSS score above.
      ...
      foreach suffix( suffixes ) {
        ...
        foreach url( urls ) {
          ...
          if( egrep( pattern:pattern, string:res, icase:TRUE ) ) {
            ...
            vuln += 'Request:\n' + chomp( req ) + '\n\nResponse:\n' + chomp( res ) + '\n\n\n';
            break; # Don't report multiple vulnerable parameter / pattern / suffixes for the very same URL
          }
        }
        if( count >= max_count || cgi_vuln )
          break; # nb: No need to continue with that much findings or with multiple vulnerable parameter / pattern / suffixes for the very same URL
      }
      if( count >= max_count || cgi_vuln )
        break;
    }
