...
if(description)
{
  ...
  script_version("2021-01-18T11:00:24+0000");
  script_cve_id("CVE-2014-4326");
  script_tag(name:"cvss_base", value:"7.5");
  script_tag(name:"cvss_base_vector", value:"AV:N/AC:L/Au:N/C:P/I:P/A:P");
  script_tag(name:"last_modification", value:"2021-01-18 11:00:24 +0000 (Mon, 18 Jan 2021)");
  script_tag(name:"creation_date", value:"2016-06-28 18:49:34 +0530 (Tue, 28 Jun 2016)");
  script_name("Elastic Logstash 'CVE-2014-4326' Remote Code Execution Vulnerability (Linux)");

  script_tag(name:"summary", value:"This host is running Elastic Logstash
  and is prone to a remote code execution vulnerability.

  This script has been merged into the VT 'Elastic Logstash 'CVE-2014-4326' Remote Code Execution Vulnerability'
