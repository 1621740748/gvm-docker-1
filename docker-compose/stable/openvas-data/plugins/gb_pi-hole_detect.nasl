...
# nb: "/admin/" is the default but have seen a few on the top-level as well. Keep the /admin/ one
# first as installs having the "/admin/" subfolder might be detected twice otherwise because a few
# of the patterns below are matching as well (on purpose).
