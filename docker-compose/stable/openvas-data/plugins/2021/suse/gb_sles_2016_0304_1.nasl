...
- bsc#904432: Backported route definition changes.");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
