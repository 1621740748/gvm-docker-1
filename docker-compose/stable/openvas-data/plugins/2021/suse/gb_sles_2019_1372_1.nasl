...
CVE-2018-1000654: Fixed a denial of service in the asn1 parser
 (bsc#1105435).");
  ...
  script_tag(name:"affected", value:"'libtasn1' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
