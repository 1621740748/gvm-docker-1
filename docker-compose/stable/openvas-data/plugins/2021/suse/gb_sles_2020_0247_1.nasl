...
CVE-2019-16777, CVE-2019-16776, CVE-2019-16775: Updated npm to 6.13.4,
 ...
 (bsc#1159352).");
  ...
  script_tag(name:"affected", value:"'nodejs6' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Module for Web Scripting 12.");
