...
Remove the usage of 'cp -r' to reduce noise in the build logs.");
  ...
  script_tag(name:"affected", value:"'containerd, docker, docker-runc, golang-github-docker-libnetwork, runc' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Module for Containers 12.");
