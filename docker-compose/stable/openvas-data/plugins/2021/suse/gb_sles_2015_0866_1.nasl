...
* possible buffer read overflow (CVE-2014-9709)");
  ...
  script_tag(name:"affected", value:"'gd' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
