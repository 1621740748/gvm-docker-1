...
CVE-2019-11498: Fixed possible denial of service (application crash) in
 ...
 data (bsc#1133384).");
  ...
  script_tag(name:"affected", value:"'wavpack' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Basesystem 15.");
