...
- bsc#938913: Improved resilience against Logjam attacks (CVE-2015-4000)
 ...
 [link moved to references].");
  ...
  script_tag(name:"affected", value:"'socat' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
