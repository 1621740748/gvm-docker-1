...
- gensslcert: CN now defaults to `hostname -f` [bnc#949766], fix help
 [bnc#949771]");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Enterprise Storage 1.0.");
