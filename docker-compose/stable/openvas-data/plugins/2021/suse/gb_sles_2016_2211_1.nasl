...
- Call textdomain in cracklib-check main function so that program
 output is translated accordingly. (bsc#928923)");
  ...
  script_tag(name:"affected", value:"'cracklib' package(s) on SUSE Studio Onsite 1.3, SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
