...
Fixed an issue where building was failing (bsc#1175574).");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
