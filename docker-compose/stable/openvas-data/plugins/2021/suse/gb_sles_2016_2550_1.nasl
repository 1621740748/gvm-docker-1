...
- CVE-2013-7447: Avoid an overflow when allocating a cairo pixbuf
 (bsc#966682).");
  ...
  script_tag(name:"affected", value:"'gtk2' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
