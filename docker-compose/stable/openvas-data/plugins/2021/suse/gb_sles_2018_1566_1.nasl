...
- CVE-2018-11235: Arbitrary code execution when recursively cloning a
 malicious repository (bsc#1095219)");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Enterprise Storage 4, SUSE CaaS Platform ALL, OpenStack Cloud Magnum Orchestration 7, HPE Helion OpenStack 8.");
