...
CVE-2019-5068: Fixed exploitable shared memory permissions vulnerability
 (bsc#1156015).");
  ...
  script_tag(name:"affected", value:"'Mesa' package(s) on SUSE Linux Enterprise Workstation Extension 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
