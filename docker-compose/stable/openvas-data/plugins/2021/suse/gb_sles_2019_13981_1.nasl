...
CVE-2019-3833: Fixed a vulnerability in process_connection() which could
 ...
 Service (bsc#1122623).");
  ...
  script_tag(name:"affected", value:"'openwsman' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
