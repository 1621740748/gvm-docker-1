...
CVE-2020-1752: Fixed a use after free in glob which could have allowed a
 ...
 execution (bsc#1167631).");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
