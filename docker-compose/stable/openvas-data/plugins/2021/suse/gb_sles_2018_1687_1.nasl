...
- Fix vfs_ceph with 'aio read size' or 'aio write size' > 0, (bsc#1093664).
 ...
 + Fix memory leak in vfs_ceph, (bso#13424).");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise High Availability 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE Enterprise Storage 5.");
