...
Fix go build failures (bsc#1121397).");
  ...
  script_tag(name:"affected", value:"'containerd, docker, docker-runc, go, go1.11, go1.12, golang-github-docker-libnetwork' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Containers 15.");
