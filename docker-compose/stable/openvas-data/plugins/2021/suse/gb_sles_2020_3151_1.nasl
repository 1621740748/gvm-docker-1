...
org.apache.http.conn.ssl.AbstractVerifier does not properly verify that
 ...
 of a certificate. [bsc#1178171, CVE-2014-3577]");
  ...
  script_tag(name:"affected", value:"'apache-commons-httpclient' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
