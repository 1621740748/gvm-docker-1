...
CVE-2019-15291: There was a NULL pointer dereference caused by a
 malicious USB device in ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux Kernel' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server 11, SUSE Linux Enterprise High Availability Extension 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
