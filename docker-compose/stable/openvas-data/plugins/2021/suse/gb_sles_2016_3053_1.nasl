...
- update to debian git version (bsc#1011293) addressed security issues:
 ...
 deref (bsc#1011292)");
  ...
  script_tag(name:"affected", value:"'w3m' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Desktop 12-SP1.");
