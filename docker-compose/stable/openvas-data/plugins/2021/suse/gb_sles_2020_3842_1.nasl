...
CVE-2018-10893: Fixed a buffer overflow on image lz checks (bsc#1101295)");
  ...
  script_tag(name:"affected", value:"'spice' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
