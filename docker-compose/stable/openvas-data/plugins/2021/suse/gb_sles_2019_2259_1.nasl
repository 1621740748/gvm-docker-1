...
CVE-2019-9518: Fixed HTTP/2 implementation that is vulnerable to a flood
 ...
 (bsc#1146093).");
  ...
  script_tag(name:"affected", value:"'nodejs10' package(s) on SUSE Linux Enterprise Module for Web Scripting 15-SP1, SUSE Linux Enterprise Module for Web Scripting 15.");
