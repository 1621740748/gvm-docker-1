...
(L1 Terminal Fault). (bsc#1104134 bsc#1087082 bsc#1087083 bsc#1089343)
 ...
 SKL-H/S/E3 R0 6-5e-3/36 000000c2->000000c6 Core Gen6, Xeon E3 v5");
  ...
  script_tag(name:"affected", value:"'Security update to ucode-intel' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Point of Sale 11-SP3.");
