...
Fixed a problem during startup, related to changes in Java 9+ APIs
 (bsc#1161025).");
  ...
  script_tag(name:"affected", value:"'tomcat' package(s) on SUSE Linux Enterprise Module for Web Scripting 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15.");
