...
OFED was adjusted to add an entry to control the loading/unloading of cxgb4 to /etc/sysconf/infiniband (bsc#926856).");
  ...
  script_tag(name:"affected", value:"'kernel modules packages' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Real Time Extension 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
