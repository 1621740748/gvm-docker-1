...
Included config files from /etc/dnsmasq.d/*.conf (bsc#1152539).");
  ...
  script_tag(name:"affected", value:"'dnsmasq' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
