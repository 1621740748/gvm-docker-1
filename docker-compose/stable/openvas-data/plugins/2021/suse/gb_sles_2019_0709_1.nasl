...
CVE-2019-6974: kvm_ioctl_create_device in virt/kvm/kvm_main.c mishandled
 ...
 use-after-free (bsc#1124729).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 26 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
