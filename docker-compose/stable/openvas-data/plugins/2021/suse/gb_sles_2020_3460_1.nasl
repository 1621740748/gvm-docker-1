 ...
 * Import of OpenJDK 8 u262 build 01
 ...
 + JDK-8035633: ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'java-1_8_0-openjdk' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Legacy Software 15-SP2, SUSE Linux Enterprise Module for Legacy Software 15-SP1.");
