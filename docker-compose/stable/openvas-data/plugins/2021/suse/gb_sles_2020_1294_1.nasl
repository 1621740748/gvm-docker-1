...
Fixed broken '--help' output (bsc#1169512).");
  ...
  script_tag(name:"affected", value:"'file' package(s) on SUSE Linux Enterprise Module for Python2 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
