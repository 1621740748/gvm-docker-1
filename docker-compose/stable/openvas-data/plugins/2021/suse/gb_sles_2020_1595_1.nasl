...
Also contains the Intel CPU Microcode update to 20200520:
 ...
 C2/M1 6-2d-7/6d 00000718->0000071a Xeon E3/E5, Core X");
  ...
  script_tag(name:"affected", value:"'ucode-intel' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
