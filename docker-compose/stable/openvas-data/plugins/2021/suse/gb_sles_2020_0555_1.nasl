...
skipped tests now ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'python-aws-sam-translator, python-boto3, python-botocore, python-cfn-lint, python-jsonschema, python-nose2, python-parameterized, python-pathlib2, python-pytest-cov, python-requests, python-s3transfer' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Manager Tools 12, SUSE Manager Server 3.2, SUSE Manager Proxy 3.2, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Point of Sale 12-SP2, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Linux Enterprise Module for Containers 12, SUSE Linux Enterprise Module for Advanced Systems Management 12, SUSE Linux Enterprise High Availability 12-SP5, SUSE Linux Enterprise High Availability 12-SP2, SUSE Linux Enterprise High Availability 12-SP1, SUSE Enterprise Storage 5, SUSE CaaS Platform 3.0, HPE Helion Openstack 8.");
