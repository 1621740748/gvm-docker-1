...
Fixed an dependency issue with pcp2csv (bsc#1129991).");
  ...
  script_tag(name:"affected", value:"'pcp' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1.");
