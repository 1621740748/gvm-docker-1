...
CVE-2019-5482: Fixed TFTP small blocksize heap buffer overflow
 (bsc#1149496).");
  ...
  script_tag(name:"affected", value:"'curl' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Enterprise Storage 5, SUSE Enterprise Storage 4, HPE Helion Openstack 8.");
