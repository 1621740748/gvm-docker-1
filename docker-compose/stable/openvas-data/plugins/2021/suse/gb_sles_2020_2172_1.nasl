 ...
 * Update documentation for XML::Twig to mention problems with
 expand_external_ents and add information about new no_xxe argument");
  ...
  script_tag(name:"affected", value:"'perl-XML-Twig' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
