...
Added new Japanese Era name support (bsc#1100396).");
  ...
  script_tag(name:"affected", value:"'glibc' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
