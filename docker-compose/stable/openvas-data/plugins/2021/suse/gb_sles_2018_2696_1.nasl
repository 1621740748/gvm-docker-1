...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/suse_sles", "ssh/login/rpms", re:"ssh/login/release=(SLES12\.0SP3|SLES12\.0)");
...
Add -fwrapv to OPTS (bsc#1107030)");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Module for Web Scripting 12, SUSE Linux Enterprise Desktop 12-SP3.");
