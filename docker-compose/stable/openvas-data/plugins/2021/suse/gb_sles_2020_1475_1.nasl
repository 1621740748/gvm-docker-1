...
CVE-2020-12654: Fixed a heap-based buffer overflow in
 ...
 AP to trigger (bsc#1171252).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 37 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Module for Live Patching 15-SP1, SUSE Linux Enterprise Module for Live Patching 15, SUSE Linux Enterprise Live Patching 12-SP5, SUSE Linux Enterprise Live Patching 12-SP4.");
