...
Add setuid bit to spice-client-glib-usb-acl-helper (bsc#1101420)");
  ...
  script_tag(name:"affected", value:"'spice-gtk' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
