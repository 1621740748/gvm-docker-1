...
- CVE-2015-0255: Check string lenghts in XkbSetGeometry request
 (bnc#915810)");
  ...
  script_tag(name:"affected", value:"'xorg-x11-server' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
