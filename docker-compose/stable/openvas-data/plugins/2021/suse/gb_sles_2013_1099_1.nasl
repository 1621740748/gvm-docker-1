...
>");
  ...
  script_tag(name:"affected", value:"'xorg-x11-libXext' package(s) on SUSE Linux Enterprise Software Development Kit 11 SP2, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Desktop 11 SP2.");
