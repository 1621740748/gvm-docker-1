...
Fixed an improper handling of certificate chain with cross-signed
 intermediate CA certificates (bsc#1172461).");
  ...
  script_tag(name:"affected", value:"'gnutls' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
