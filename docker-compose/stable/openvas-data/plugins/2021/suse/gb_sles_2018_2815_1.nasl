...
CVE-2016-4975: Fixed possible CRLF injection allowing HTTP response
 ...
 'Location' or other outbound header key or value. (bsc#1104826)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 4.");
