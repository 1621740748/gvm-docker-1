...
- CVE-2017-2626: Creation of the ICE auth session cookies used
 ...
 generation method has been implemented. (boo#1025068)");
  ...
  script_tag(name:"affected", value:"'libICE' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
