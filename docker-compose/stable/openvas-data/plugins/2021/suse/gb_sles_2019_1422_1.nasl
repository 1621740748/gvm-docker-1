...
CVE-2018-14734: drivers/infiniband/core/ucma.c allowed
 ...
 service (use-after-free) (bsc#1131390).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 29 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Live Patching 12-SP3.");
