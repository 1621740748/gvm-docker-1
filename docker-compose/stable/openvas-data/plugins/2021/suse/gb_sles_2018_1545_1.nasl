...
- CVE-2018-1087: kernel KVM was vulnerable to a flaw in the way the Linux
 ...
 in the guest (bsc#1090869) before");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 13 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
