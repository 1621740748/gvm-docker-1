...
- Ensure ShowLocalGreeter configuration key is properly handled
 (bgo#743440).");
  ...
  script_tag(name:"affected", value:"'gdm' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
