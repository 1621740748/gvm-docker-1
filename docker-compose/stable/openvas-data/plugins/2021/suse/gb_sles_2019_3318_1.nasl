...
if(description)
{
 ...
 (bsc#1158109).");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15, SUSE Linux Enterprise High Availability 15.");
