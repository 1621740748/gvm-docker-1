...
- Several vulnerabilities in standard conforming implementations of the
 ...
 CVE-2017-13088]");
  ...
  script_tag(name:"affected", value:"'wpa_supplicant' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Point of Sale 11-SP3.");
