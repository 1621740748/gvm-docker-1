...
shim-install: install MokManager to \EFI\boot to process the pending MOK
 request (bsc#1175626, bsc#1175656)");
  ...
  script_tag(name:"affected", value:"'shim' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
