...
CVE-2018-10925: Add missing authorization check on certain statements
 ...
 other columns in the same table (bsc#1104202).");
  ...
  script_tag(name:"affected", value:"'postgresql10' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
