...
CVE-2018-10902: It was found that the raw midi kernel driver did not
 ...
 (bsc#1105323).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 24 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
