...
CVE-2018-1000222: Fixed a double free vulnerability in gdImageBmpPtr()
 ...
 exploited via a specially crafted JPEG image files. (bsc#1105434)");
  ...
  script_tag(name:"affected", value:"'gd' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
