...
CVE-2018-20060: Remove Authorization header when redirecting cross-host
 (bsc#1119376).");
  ...
  script_tag(name:"affected", value:"'python-urllib3' package(s) on SUSE Manager Server 3.2, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Enterprise Storage 5, SUSE Enterprise Storage 4, SUSE CaaS Platform 3.0.");
