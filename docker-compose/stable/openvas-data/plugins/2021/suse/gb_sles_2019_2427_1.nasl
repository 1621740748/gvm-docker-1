...
CVE-2019-14822: Fixed misconfiguration of the DBus server allows to
 ...
 of another user (bsc#1150011).");
  ...
  script_tag(name:"affected", value:"'ibus' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1.");
