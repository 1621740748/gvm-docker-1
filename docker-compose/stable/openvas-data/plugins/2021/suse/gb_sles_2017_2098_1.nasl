...
- CVE-2017-9242: The __ip6_append_data function in net/ipv6/ip6_output.c
 ...
 denial of service (system crash) via crafted system calls (bsc#1042892).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 23 for SLE 12' package(s) on SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12.");
