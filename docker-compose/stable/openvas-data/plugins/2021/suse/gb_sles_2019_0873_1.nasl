...
CVE-2019-0196: Through specially crafted network input the Apache's
 ...
 being misclassified and thus being processed incorrectly. [bsc#1131237]");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15.");
