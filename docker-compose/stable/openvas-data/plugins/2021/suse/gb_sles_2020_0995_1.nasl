...
CVE-2020-10933: Heap exposure vulnerability in the socket library
 (bsc#1168938).");
  ...
  script_tag(name:"affected", value:"'ruby2.5' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
