...
- CVE-2015-8079: QtWebKit logs visited URLs to WebpageIcons.db in private
 browsing mode (bsc#954210).");
  ...
  script_tag(name:"affected", value:"'flex, at, bogofilter, cyrus-imapd, kdelibs4, libQtWebKit4, libbonobo, mdbtools, netpbm, openslp, sgmltool, virtuoso, libqt5-qtwebkit' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
