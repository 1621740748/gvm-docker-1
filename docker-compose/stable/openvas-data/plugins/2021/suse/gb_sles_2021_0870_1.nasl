...
CVE-2020-28374: Fixed insufficient identifier checking in the LIO SCSI
 ...
 write files via directory traversal in an XCOPY request (bsc#1178684).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 36 for SLE 12 SP2)' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
