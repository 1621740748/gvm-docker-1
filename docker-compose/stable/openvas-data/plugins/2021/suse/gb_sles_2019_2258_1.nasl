...
Fixed that passwords are not echoed on terminal when asking for them
 (bsc#990204).");
  ...
  script_tag(name:"affected", value:"'NetworkManager' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP4, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
