...
CVE-2020-8625: A vulnerability in BIND's GSSAPI security policy
 ...
 CVE-2020-8625]");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, HPE Helion Openstack 8.");
