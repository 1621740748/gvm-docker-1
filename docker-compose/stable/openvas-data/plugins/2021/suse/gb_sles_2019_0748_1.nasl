...
Fix off-by-one bounds check on CHM PMGI/PMGL chunk numbers and reject
 empty filenames.");
  ...
  script_tag(name:"affected", value:"'libmspack' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
