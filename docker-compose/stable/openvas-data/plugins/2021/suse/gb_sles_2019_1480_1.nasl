...
Allow defaults sudoRole without sudoUser attribute (bsc#1135247)");
  ...
  script_tag(name:"affected", value:"'sssd' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
