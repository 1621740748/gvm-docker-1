...
Fixed a permission issue which have resulted in build failures
 (bsc#1168170).");
  ...
  script_tag(name:"affected", value:"'mgetty' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
