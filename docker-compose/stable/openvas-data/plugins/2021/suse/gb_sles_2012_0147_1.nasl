 ...
 * Fix race condition with variables and autoload.");
  ...
  script_tag(name:"affected", value:"'ruby' package(s) on WebYaST 1.2, SUSE Studio Standard Edition 1.2, SUSE Studio Onsite 1.2, SUSE Studio Onsite 1.1, SUSE Studio Extension for System z 1.2, SUSE Linux Enterprise Software Development Kit 11 SP1, SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise Desktop 11 SP1, SUSE Lifecycle Management Server 1.1.");
