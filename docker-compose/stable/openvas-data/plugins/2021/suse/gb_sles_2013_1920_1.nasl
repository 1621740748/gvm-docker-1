...
The update blacklists an intermediate CA that was abused to create man in the middle certificates.");
  ...
  script_tag(name:"affected", value:"'libfreebl3' package(s) on SUSE Linux Enterprise Software Development Kit 11 SP2, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Desktop 11 SP2.");
