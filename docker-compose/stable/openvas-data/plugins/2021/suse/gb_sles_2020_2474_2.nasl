...
CVE-2020-14363: Fix an integer overflow in init_om() (bsc#1175239).");
  ...
  script_tag(name:"affected", value:"'libX11' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15.");
