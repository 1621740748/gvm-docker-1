 ...
 * bonding: do ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux kernel' package(s) on SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise High Availability Extension 11 SP1, SUSE Linux Enterprise Desktop 11 SP1, SLE 11.");
