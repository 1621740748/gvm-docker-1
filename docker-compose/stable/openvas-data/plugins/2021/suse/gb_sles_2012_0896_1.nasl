...
(XSS) attack through the context menu using a data: URL. In this issue, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Mozilla Firefox' package(s) on SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise Desktop 11 SP2, SUSE Linux Enterprise Desktop 11 SP1.");
