...
CVE-2018-5390: Fixed a denial of service ('SegmentSmack') in
 ...
 packet (bsc#1102682).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 32 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
