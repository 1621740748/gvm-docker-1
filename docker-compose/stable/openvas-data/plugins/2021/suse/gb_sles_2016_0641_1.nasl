...
- CVE-2016-0704 (bsc#968053): 'Bleichenbacher oracle in SSLv2' This issue
 ...
 have made the above 'DROWN' ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Module for Legacy Software 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
