...
CVE-2015-5186: Audit: log terminal emulator escape sequences handling
 (bsc#941922)");
  ...
  script_tag(name:"affected", value:"'audit' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
