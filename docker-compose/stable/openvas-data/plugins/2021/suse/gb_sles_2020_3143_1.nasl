...
CVE-2020-25637: Fixed a double free in qemuAgentGetInterfaces()
 (bsc#1177155).");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
