...
avoid bad interaction with python-cryptography package. (bsc#1021578)");
  ...
  script_tag(name:"affected", value:"'python-cryptography, python-pyOpenSSL' package(s) on SUSE OpenStack Cloud 7, SUSE OpenStack Cloud 6, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Linux Enterprise Module for Containers 12, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Desktop 12-SP3, SUSE Enterprise Storage 4, SUSE CaaS Platform ALL, SUSE CaaS Platform 3.0, OpenStack Cloud Magnum Orchestration 7.");
