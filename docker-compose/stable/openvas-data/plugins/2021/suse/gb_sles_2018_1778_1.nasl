...
- CVE-2017-1000250: Fix information disclosure vulnerability in
 service_search_attr_req (bsc#1057342).");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
