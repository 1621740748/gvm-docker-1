...
CVE-2019-13057: Fixed an issue with improper authorization with
 delegated database admin privileges (bsc#1143273).");
  ...
  script_tag(name:"affected", value:"'openldap2' package(s) on SUSE Linux Enterprise Server for SAP 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Module for Legacy Software 12.");
