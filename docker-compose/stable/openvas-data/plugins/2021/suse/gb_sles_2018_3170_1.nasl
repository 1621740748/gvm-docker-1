...
CVE-2017-16827: The aout_get_external_symbols function in the Binary
 File ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'binutils' package(s) on SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
