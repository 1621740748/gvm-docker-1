...
CVE-2018-15120: Fixed a denial of service when parsing emoji
 (bsc#1103877)");
  ...
  script_tag(name:"affected", value:"'pango' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
