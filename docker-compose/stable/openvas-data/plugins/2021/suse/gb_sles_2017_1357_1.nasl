 ...
 * fix 'git log -L...' buffer overrun");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, OpenStack Cloud Magnum Orchestration 7.");
