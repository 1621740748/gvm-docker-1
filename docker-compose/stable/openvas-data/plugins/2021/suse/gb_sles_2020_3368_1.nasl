 ...
 * go#40974 cmd/link: sectionForAddress(0xA9D67F) address not in any
 section file");
  ...
  script_tag(name:"affected", value:"'go1.15' package(s) on SUSE Linux Enterprise Module for Development Tools 15-SP2, SUSE Linux Enterprise Module for Development Tools 15-SP1.");
