...
Fixed a denial-of-service condition from exponential explosion
 ...
 malicious SVGs.");
  ...
  script_tag(name:"affected", value:"'librsvg' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4.");
