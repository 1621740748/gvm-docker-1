...
- Crop operations to visible screen. (bnc#1032272)");
  ...
  script_tag(name:"affected", value:"'tigervnc' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
