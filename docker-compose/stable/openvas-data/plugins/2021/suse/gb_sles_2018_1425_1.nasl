...
- Fix a GSS failure in legacy applications by not indicating deprecated
 GSS mechanisms in gss_indicate_mech() list. (bsc#1081725)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
