...
- CVE-2015-2059: out-of-bounds read with stringprep on invalid UTF-8
 (bsc#923241)");
  ...
  script_tag(name:"affected", value:"'libidn' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
