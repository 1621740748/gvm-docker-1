...
- fix small mistake in the backport for (bsc#986630)");
  ...
  script_tag(name:"affected", value:"'ruby' package(s) on SUSE Webyast 1.3, SUSE Studio Onsite 1.3, SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Lifecycle Management Server 1.3.");
