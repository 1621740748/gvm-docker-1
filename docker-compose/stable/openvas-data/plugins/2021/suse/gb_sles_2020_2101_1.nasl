...
CVE-2020-13867: Fixed the permissions in /etc/target (bsc#1172743)");
  ...
  script_tag(name:"affected", value:"'targetcli-fb' package(s) on SUSE Linux Enterprise Module for Python2 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2.");
