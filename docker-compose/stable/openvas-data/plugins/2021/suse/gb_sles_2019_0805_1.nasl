...
The adcli enables sssd to do password renewal when using Active Directory.");
  ...
  script_tag(name:"affected", value:"'adcli, sssd' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
