...
CVE-2018-9154: Fixed a potential denial of service in
 jpc_dec_process_sot() (bsc#1092115).");
  ...
  script_tag(name:"affected", value:"'jasper' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2.");
