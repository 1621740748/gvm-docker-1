...
CVE-2020-26117: Server certificates were stored as certiticate
 ...
 (bsc#1176733)");
  ...
  script_tag(name:"affected", value:"'tigervnc' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud 9, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4.");
