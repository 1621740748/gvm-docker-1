...
if(description)
{
 ...
 group to install packages without root password (bsc#1086936).");
  ...
  script_tag(name:"affected", value:"'PackageKit' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
