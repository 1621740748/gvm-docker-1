...
- CVE-2018-6798: Fixed heap buffer overflow in regexec.c (bsc#1082233).");
  ...
  script_tag(name:"affected", value:"'perl' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
