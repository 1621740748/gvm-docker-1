...
- CVE-2018-10853: A flaw was found in kvm. In which certain instructions
 ...
 (bsc#1097108).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 9 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Live Patching 12-SP3.");
