...
CVE-2018-5390: Linux kernel could be forced to make very expensive calls
 ...
 packet which can lead to a denial of service (bsc#1102682).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 34 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1.");
