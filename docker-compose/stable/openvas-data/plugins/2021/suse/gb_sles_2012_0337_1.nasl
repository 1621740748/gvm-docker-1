...
>");
  ...
  script_tag(name:"affected", value:"'Samba' package(s) on SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Server 10 SP3, SUSE Linux Enterprise Desktop 10 SP4, SLE SDK 10 SP4.");
