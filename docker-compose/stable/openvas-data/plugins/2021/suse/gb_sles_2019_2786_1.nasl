...
CVE-2019-16884: Fixed an LSM bypass via malicious Docker images that
 mount over a /proc directory. (bsc#1152308)");
  ...
  script_tag(name:"affected", value:"'docker-runc' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Containers 15-SP1, SUSE Linux Enterprise Module for Containers 15.");
