...
Notify service manager when it shutdown and cleanup temporary files when
 PackageKit quits. (bsc#1169739)");
  ...
  script_tag(name:"affected", value:"'PackageKit' package(s) on SUSE Linux Enterprise Workstation Extension 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1.");
