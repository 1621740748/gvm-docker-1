...
picmg discover messages are now DEBUG and not INFO messages
 (bsc#1085469).");
  ...
  script_tag(name:"affected", value:"'ipmitool' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15.");
