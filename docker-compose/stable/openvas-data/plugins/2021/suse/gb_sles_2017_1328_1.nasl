...
if(description)
{
 ...
 denial-of-service (bsc#1037559)");
  ...
  script_tag(name:"affected", value:"'rpcbind' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
