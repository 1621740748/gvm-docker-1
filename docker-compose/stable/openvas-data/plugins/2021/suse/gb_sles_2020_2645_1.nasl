...
CVE-2020-14393: Fixed a buffer overflow on an overlong DBD class name
 (bsc#1176409).");
  ...
  script_tag(name:"affected", value:"'perl-DBI' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
