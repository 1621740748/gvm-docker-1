...
Remove wheel tag calculation from pip and use packaging.tags. This
 ...
 environment variables. Values that may be either URL or path ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'python-pip, python-scripttest' package(s) on SUSE Linux Enterprise Module for Python2 15-SP2, SUSE Linux Enterprise Module for Python2 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
