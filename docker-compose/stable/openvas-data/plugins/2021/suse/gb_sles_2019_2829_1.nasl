...
CVE-2019-17133: Fixed a buffer overflow in cfg80211_mgd_wext_giwessid in
 net/wireless/wext-sme.c caused by long SSID IEs (bsc#1153158).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 35 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Module for Live Patching 15-SP1, SUSE Linux Enterprise Module for Live Patching 15, SUSE Linux Enterprise Live Patching 12-SP4.");
