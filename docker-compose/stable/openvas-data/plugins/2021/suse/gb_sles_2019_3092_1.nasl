...
CVE-2019-18408: Fixed a use-after-free in RAR format support
 (bsc#1155079).");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
