...
This helps during booting of the system in FIPS mode with insufficient entropy.");
  ...
  script_tag(name:"affected", value:"'libgcrypt' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
