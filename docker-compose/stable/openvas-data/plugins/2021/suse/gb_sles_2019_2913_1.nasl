...
Handle most of new s390 arch13 instructions. [fate#327369, jsc#ECO-368]");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1.");
