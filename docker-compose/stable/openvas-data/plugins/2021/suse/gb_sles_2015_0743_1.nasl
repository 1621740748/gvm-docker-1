...
- CVE-2014-6555: Unspecified vulnerability in Oracle MySQL Server 5.5.39
 ...
 to SERVER:DML ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'mariadb' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
