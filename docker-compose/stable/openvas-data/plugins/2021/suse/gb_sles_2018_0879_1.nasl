 ...
 * gensslcert: fall back to 'localhost' as hostname [bsc#1057406]");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1.");
