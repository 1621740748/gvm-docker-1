...
- CVE-2017-8890: The inet_csk_clone_lock function in
 ...
 other impact by leveraging use of the accept system call (bsc#1038564).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 7 for SLE 12 SP1' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1.");
