...
alsa: usb-audio: ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux Azure Kernel' package(s) on SUSE Linux Enterprise Module for Public Cloud 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1.");
