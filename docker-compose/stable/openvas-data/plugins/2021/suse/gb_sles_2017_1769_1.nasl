...
* CVE-2017-9128: A heap-based buffer over-read in quicktime_video_width
 via a crafted mp4 file was fixed. (bsc#1044000)");
  ...
  script_tag(name:"affected", value:"'libquicktime' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
