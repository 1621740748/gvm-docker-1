...
- Enabled --enable-fastvalidate option in configure (bsc#1044970)");
  ...
  script_tag(name:"affected", value:"'unixODBC' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
