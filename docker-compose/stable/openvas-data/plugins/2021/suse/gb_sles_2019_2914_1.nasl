...
Add gdb-s390-handle-arch13.diff to handle most new s390 arch13
 instructions. [fate#327369, jsc#ECO-368]");
  ...
  script_tag(name:"affected", value:"'gdb' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1.");
