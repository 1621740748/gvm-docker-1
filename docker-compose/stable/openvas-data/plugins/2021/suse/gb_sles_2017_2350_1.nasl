...
python-paramiko was adjusted to work together with this python-pycrypto change. (bsc#1047666)");
  ...
  script_tag(name:"affected", value:"'python-pycrypto' package(s) on SUSE OpenStack Cloud 7, SUSE OpenStack Cloud 6, SUSE Manager Tools 12, SUSE Manager Server 3.1, SUSE Manager Server 3.0, SUSE Manager Proxy 3.1, SUSE Manager Proxy 3.0, SUSE Linux Enterprise Point of Sale 12-SP2, SUSE Linux Enterprise Module for Web Scripting 12, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Linux Enterprise Module for Advanced Systems Management 12, SUSE Enterprise Storage 4, SUSE Enterprise Storage 3, SUSE Container as a Service Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
