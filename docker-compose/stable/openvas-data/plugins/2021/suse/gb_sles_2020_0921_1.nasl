...
CVE-2019-13114: Fixed a null pointer dereference which might have led to
 ...
 (bsc#1142684).");
  ...
  script_tag(name:"affected", value:"'exiv2' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1.");
