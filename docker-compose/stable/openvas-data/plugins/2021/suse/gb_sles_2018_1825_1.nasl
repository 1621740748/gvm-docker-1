...
* CVE-2018-1152: Fixed a denial of service in start_input_bmp() rdbmp.c
 ...
 [bsc#1098155]");
  ...
  script_tag(name:"affected", value:"'jpeg' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
