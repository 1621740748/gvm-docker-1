...
- bsc#1055047: Fixed --initrd-inject option in virt-install");
  ...
  script_tag(name:"affected", value:"'xen' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE Container as a Service Platform ALL.");
