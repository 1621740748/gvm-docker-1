...
if(description)
{
 ...
 of boundary memory writes (bsc#1003002, CVE-2016-7949, CVE-2016-7950)");
  ...
  script_tag(name:"affected", value:"'xorg-x11-libXrender' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
