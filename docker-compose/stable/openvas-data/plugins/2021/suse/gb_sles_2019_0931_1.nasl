...
Fix libldap leaks socket descriptors issue (bsc#1065083)");
  ...
  script_tag(name:"affected", value:"'openldap2' package(s) on SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Module for Legacy Software 12.");
