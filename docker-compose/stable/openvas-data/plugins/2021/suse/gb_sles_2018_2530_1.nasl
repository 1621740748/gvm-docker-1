...
- CVE-2016-10708: Prevent DoS due to crashes caused by out-of-sequence
 NEWKEYS message (bsc#1076957).");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 4, OpenStack Cloud Magnum Orchestration 7.");
