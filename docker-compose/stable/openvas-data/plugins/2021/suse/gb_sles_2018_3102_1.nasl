...
Expose 64-bit sequence number from XCB API so that Xlib and others can
 ...
 on 32-bit environment. (bsc#1094327)");
  ...
  script_tag(name:"affected", value:"'libX11 and libxcb' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
