...
CVE-2019-11599: The coredump implementation in the Linux kernel did not
 ...
 fs/proc/task_mmu.c, and ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux Kernel' package(s) on SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise High Availability 12-SP3, SUSE Enterprise Storage 5, SUSE CaaS Platform 3.0.");
