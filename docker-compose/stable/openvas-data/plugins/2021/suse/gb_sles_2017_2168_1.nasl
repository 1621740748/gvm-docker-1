...
[link moved to references]
 .8.0");
  ...
  script_tag(name:"affected", value:"'nodejs4, nodejs6' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Module for Web Scripting 12, SUSE Enterprise Storage 4.");
