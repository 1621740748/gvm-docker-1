...
CVE-2019-5108: Fixed an issue where by triggering AP to send IAPP
 ...
 has completed could have led to denial-of-service (bsc#1159913).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 36 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Module for Live Patching 15-SP1, SUSE Linux Enterprise Module for Live Patching 15, SUSE Linux Enterprise Live Patching 12-SP5, SUSE Linux Enterprise Live Patching 12-SP4.");
