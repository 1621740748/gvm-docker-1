 ...
 * [link moved to references]");
  ...
  script_tag(name:"affected", value:"'postgresql10' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
