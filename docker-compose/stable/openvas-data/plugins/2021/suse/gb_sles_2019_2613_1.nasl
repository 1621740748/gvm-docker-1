...
CVE-2019-14835: A buffer overflow flaw was found in the way vhost
 ...
 (bsc#1151021).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 32 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1.");
