...
* CVE-2015-4472: Off-by-one error in the READ_ENCINT macro in chmd.c in
 ...
 crafted CHM file (bnc#934529).");
  ...
  script_tag(name:"affected", value:"'libmspack' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
