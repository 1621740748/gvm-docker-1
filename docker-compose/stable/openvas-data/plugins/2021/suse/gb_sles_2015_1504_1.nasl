...
* MFSA 2015-95/CVE-2015-4498 (bsc#943558): Add-on notification bypass
 through data URLs");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox' package(s) on SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Server 11-SP1, SUSE Linux Enterprise Debuginfo 11-SP2, SUSE Linux Enterprise Debuginfo 11-SP1.");
