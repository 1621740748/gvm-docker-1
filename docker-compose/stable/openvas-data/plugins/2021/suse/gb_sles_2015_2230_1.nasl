...
- Improve S/390 performance on IBM z196 and z13 (bsc#954256)");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
