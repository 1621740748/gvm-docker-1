...
All extensions must now be signed by addons.mozilla.org. Please read README.SUSE for more details.");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, MozillaFirefox-branding-SLED, mozilla-nspr and mozilla-nss' package(s) on SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Debuginfo 11-SP2.");
