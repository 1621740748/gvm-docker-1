...
- CVE-2016-9603: A privileged user within the guest VM could have caused a
 ...
 privileges to that of the device model process (bsc#1028655)");
  ...
  script_tag(name:"affected", value:"'xen' package(s) on SUSE OpenStack Cloud 5, SUSE Manager Proxy 2.1, SUSE Manager 2.1, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Point of Sale 11-SP3.");
