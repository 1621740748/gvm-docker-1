...
- Fix a heap-based buffer overflow (CVE-2016-1541, bsc#979005)");
  ...
  script_tag(name:"affected", value:"'libarchive' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
