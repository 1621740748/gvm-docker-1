...
- Heap overflow via specially crafted .flac files (CVE-2014-9028).");
  ...
  script_tag(name:"affected", value:"'flac' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
