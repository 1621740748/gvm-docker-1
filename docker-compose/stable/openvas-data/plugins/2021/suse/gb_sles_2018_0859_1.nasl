...
- Avoid indefinite polling in KDC communication. (bsc#970696)");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
