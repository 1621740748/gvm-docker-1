...
- Provide and obsolete clamav-nodb to trigger its removal in openSUSE
 Leap. (bsc#1040662)");
  ...
  script_tag(name:"affected", value:"'clamav' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP2.");
