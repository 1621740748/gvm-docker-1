...
Docker version update to version 18.09.0-ce (bsc#1115464)");
  ...
  script_tag(name:"affected", value:"'docker' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Containers 15.");
