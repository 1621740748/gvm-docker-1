...
- CVE-2017-7585: stack-based buffer overflow via a specially crafted FLAC
 file (bsc#1033054)");
  ...
  script_tag(name:"affected", value:"'libsndfile' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
