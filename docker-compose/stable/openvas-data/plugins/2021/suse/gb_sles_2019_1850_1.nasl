...
CVE-2019-6237, CVE-2019-8571, CVE-2019-8583, CVE-2019-8584,
 ...
 CVE-2019-8611, CVE-2019-8619, CVE-2019-8622, CVE-2019-8623 (bsc#1135715).");
  ...
  script_tag(name:"affected", value:"'webkit2gtk3' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP4, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
