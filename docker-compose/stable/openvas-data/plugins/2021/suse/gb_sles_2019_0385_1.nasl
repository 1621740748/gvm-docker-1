...
CVE-2019-5736: Effectively copying /proc/self/exe during re-exec to
 ...
 container breakout (bsc#1121967)");
  ...
  script_tag(name:"affected", value:"'docker-runc' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Module for Containers 12, OpenStack Cloud Magnum Orchestration 7.");
