...
CVE-2020-14386: Fixed a memory corruption which could have lead to an
 ...
 integrity (bsc#1176069).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 29 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
