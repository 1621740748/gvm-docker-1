...
- Fix when HISTSIZE=0 and chattr +a .bash_history (bsc#1031729)");
  ...
  script_tag(name:"affected", value:"'bash' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
