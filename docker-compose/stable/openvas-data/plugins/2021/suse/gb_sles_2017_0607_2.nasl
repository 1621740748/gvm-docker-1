...
- Properly verify CIDR masks in the AllowUsers and DenyUsers configuration
 lists (bsc#1005893)");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
