...
Fixed an issue with the CLI client, where a ModuleNotFoundError was
 triggered (bsc#1092493).");
  ...
  script_tag(name:"affected", value:"'aws-cli' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Module for Public Cloud 12, HPE Helion Openstack 8.");
