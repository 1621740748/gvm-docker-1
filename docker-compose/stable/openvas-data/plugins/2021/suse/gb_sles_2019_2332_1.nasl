...
CVE-2019-11236: Fixed CRLF injection via request parameter (bsc#1132663).");
  ...
  script_tag(name:"affected", value:"'python-urllib3' package(s) on SUSE Linux Enterprise Module for Python2 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
