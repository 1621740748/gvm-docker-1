...
- A crafted AVI file could have caused an invalid memory read, possibly
 causing DoS or corruption (bsc#1024051, CVE-2017-5838)");
  ...
  script_tag(name:"affected", value:"'gstreamer' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
