...
CVE-2018-17096: The BPMDetect class allowed remote attackers to cause a
 ...
 demonstrated by SoundStretch. (bsc#1108630)");
  ...
  script_tag(name:"affected", value:"'soundtouch' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
