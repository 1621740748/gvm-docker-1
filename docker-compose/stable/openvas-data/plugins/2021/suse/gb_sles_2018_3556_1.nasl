...
if(description)
{
  ...
  script_tag(name:"affected", value:"'Test-update for SLE-12-SP4 (security)' package(s) on SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
