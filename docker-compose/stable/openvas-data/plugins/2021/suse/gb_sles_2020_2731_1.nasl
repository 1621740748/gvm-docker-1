...
Bugfixes
 ...
 (attempting to bind to ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'conmon, fuse-overlayfs, libcontainers-common, podman' package(s) on SUSE Linux Enterprise Module for Containers 15-SP2, SUSE Linux Enterprise Module for Containers 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
