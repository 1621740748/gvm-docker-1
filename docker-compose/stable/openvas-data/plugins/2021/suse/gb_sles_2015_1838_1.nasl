...
* polkit had a memory leak (bsc#912889)");
  ...
  script_tag(name:"affected", value:"'polkit' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
