...
CVE-2017-6888: An error in the 'read_metadata_vorbiscomment_()' function
 ...
 file (bsc#1091045).");
  ...
  script_tag(name:"affected", value:"'flac' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
