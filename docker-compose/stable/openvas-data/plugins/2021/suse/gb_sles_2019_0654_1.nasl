...
Directory listing without authentication fixed (bsc#1092206).");
  ...
  script_tag(name:"affected", value:"'openwsman' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15.");
