...
Fix description of --table-style,-s in man page (bsc#1154804).");
  ...
  script_tag(name:"affected", value:"'libsolv, libzypp, zypper' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
