...
- CVE-2016-9576: The blk_rq_map_user_iov function in block/blk-map.c in
 ...
 access to a /dev/sg device (bsc#1014271).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 16 for SLE 12' package(s) on SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12.");
