...
Add fibre channel device's ofpath support to grub-ofpathname and search
 hint to speed up root device discovery (bsc#1172745).");
  ...
  script_tag(name:"affected", value:"'grub2' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
