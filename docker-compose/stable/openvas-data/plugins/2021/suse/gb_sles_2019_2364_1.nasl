...
CVE-2018-16889: Fixed missing sanitation of customer encryption keys
 from log output in v4 auth. (bsc#1121567)");
  ...
  script_tag(name:"affected", value:"'ceph' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4, SUSE Enterprise Storage 5, SUSE CaaS Platform 3.0.");
