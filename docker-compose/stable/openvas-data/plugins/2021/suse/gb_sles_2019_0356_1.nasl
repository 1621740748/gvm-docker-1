...
CVE-2018-16884: A flaw was found in the Linux kernel's NFS41+ subsystem.
 ...
 (bsc#1119947).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 31 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1.");
