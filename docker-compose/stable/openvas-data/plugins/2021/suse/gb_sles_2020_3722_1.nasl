...
CVE-2020-1971: Fixed a null pointer dereference in EDIPARTYNAME
 (bsc#1179491).");
  ...
  script_tag(name:"affected", value:"'openssl-1_1' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15.");
