...
CVE-2018-1152: Fixed a denial of service in start_input_bmp() rdbmp.c
 ...
 (bsc#1098155)");
  ...
  script_tag(name:"affected", value:"'libjpeg-turbo' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
