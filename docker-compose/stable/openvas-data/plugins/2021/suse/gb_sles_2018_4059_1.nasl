...
CVE-2018-4700: Fixed extremely predictable cookie generation that is
 ...
 (bsc#1115750).");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
