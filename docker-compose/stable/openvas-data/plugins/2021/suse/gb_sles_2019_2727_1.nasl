...
Use IPv6 when called as dhclient6, dhcpd6, and dhcrelay6 (bsc#1136572).");
  ...
  script_tag(name:"affected", value:"'dhcp' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4, SUSE CaaS Platform 3.0.");
