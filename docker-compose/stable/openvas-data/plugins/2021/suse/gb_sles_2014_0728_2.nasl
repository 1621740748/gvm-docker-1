...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/suse_sles", "ssh/login/rpms", re:"ssh/login/release=(SLES11\.0SP2|SLES10\.0SP4|SLES10\.0SP3)");
 ...
 * CVE-2014-0878");
  ...
  script_tag(name:"affected", value:"'IBM Java 6' package(s) on SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Server 10 SP3.");
