 ...
 * CVE-2018-1302: when an HTTP/2 stream was destroyed after being
 ...
 it is classified as low risk. [bsc#1086820]");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
