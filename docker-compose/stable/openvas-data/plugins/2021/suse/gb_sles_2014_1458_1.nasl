...
if(description)
{
  ...
  script_mandatory_keys("ssh/login/suse_sles", "ssh/login/rpms", re:"ssh/login/release=(SLES11\.0SP3|SLES11\.0SP1)");
 ...
 * CVE-2014-1586");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox' package(s) on SUSE Linux Enterprise Software Development Kit 11 SP3, SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise Desktop 11 SP3.");
