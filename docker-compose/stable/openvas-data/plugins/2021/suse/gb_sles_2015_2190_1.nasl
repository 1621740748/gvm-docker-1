...
- CVE-2015-3225: Crafted requests could have caused a SystemStackError
 leading to Denial of Service (bsc#934797).");
  ...
  script_tag(name:"affected", value:"'rubygem-rack-1_4' package(s) on SUSE Linux Enterprise Module for Containers 12, SUSE Enterprise Storage 2, SUSE Enterprise Storage 1.0.");
