...
- CVE-2017-10788: The DBD::mysql module through 4.043 for Perl allows
 ...
 and code examples. (bsc#1047095)");
  ...
  script_tag(name:"affected", value:"'perl-DBD-mysql' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
