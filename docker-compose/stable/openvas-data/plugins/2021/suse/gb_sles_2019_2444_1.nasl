...
Fixed segfault when libtiff encounters corrupted TIFF (upstream issue
 #295).");
  ...
  script_tag(name:"affected", value:"'djvulibre' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
