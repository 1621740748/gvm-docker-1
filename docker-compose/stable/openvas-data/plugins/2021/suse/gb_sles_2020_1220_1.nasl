...
CVE-2020-12268: Fixed a heap-based buffer overflow in
 jbig2_image_compose (bsc#1170603).");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
