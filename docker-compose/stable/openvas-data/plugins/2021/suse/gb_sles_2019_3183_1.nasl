...
Fixed a regression which caused sagmentation fault (bsc#1157198).");
  ...
  script_tag(name:"affected", value:"'permissions' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
