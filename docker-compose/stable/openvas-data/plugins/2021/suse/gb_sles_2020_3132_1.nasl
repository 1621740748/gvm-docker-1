...
CVE-2020-17489: reset auth prompt on vt switch before fade in
 loginDialog (bsc#1175155).");
  ...
  script_tag(name:"affected", value:"'gnome-settings-daemon, gnome-shell' package(s) on SUSE Linux Enterprise Workstation Extension 15-SP2, SUSE Linux Enterprise Module for Desktop Applications 15-SP2.");
