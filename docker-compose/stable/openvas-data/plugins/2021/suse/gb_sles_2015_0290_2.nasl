...
- Work around replay cache creation race, (bnc#898439).");
  ...
  script_tag(name:"affected", value:"'krb5' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Build System Kit 12.");
