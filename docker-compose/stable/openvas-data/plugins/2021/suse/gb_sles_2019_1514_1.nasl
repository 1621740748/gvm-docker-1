...
CVE-2018-15664: Fixed an issue which made docker cp vulnerable to
 symlink-exchange race attacks (bsc#1096726).");
  ...
  script_tag(name:"affected", value:"'docker' package(s) on SUSE Linux Enterprise Module for Containers 12, SUSE CaaS Platform 3.0, OpenStack Cloud Magnum Orchestration 7.");
