...
charts: ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'libepubgen, liblangtag, libmwaw, libnumbertext, libreoffice, libstaroffice, libwps, myspell-dictionaries, xmlsec1' package(s) on SUSE Linux Enterprise Workstation Extension 15, SUSE Linux Enterprise Module for Packagehub Subpackages 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
