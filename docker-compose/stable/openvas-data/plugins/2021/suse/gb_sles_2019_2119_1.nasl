...
Update to version git.fc5a7d91d54cc98f64fc28f9e288b46a0bee756c, which is
 required by docker (bsc#1142413).");
  ...
  script_tag(name:"affected", value:"'containerd, docker, docker-runc, golang-github-docker-libnetwork' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Module for Containers 12, SUSE CaaS Platform 3.0.");
