...
- Fixed bolder font in Qt4 apps (boo#956357)");
  ...
  script_tag(name:"affected", value:"'libqt4' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
