...
- CVE-2018-14424: The daemon in GDM did not properly unexport display
 ...
 potential code execution (bsc#1103737).");
  ...
  script_tag(name:"affected", value:"'gdm' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
