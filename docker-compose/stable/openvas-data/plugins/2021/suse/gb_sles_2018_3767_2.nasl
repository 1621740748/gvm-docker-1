...
Ship systemd-sysv-install helper via the main package This script was
 ...
 Therefore it's never been a SySV init tool.");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
