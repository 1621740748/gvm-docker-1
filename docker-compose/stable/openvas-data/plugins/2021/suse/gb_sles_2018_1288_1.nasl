...
Update to version 2.40.19:
 ...
 + bgo#786372 - Fix the default for the 'type' attribute of the");
  ...
  script_tag(name:"affected", value:"'librsvg' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
