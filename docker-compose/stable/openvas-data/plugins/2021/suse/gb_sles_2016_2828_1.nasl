...
- CVE-2016-7947, CVE-2016-7948: insufficient validation of data from the X
 server can cause out of boundary memory writes (bsc#1003000)");
  ...
  script_tag(name:"affected", value:"'X Window System client libraries' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
