...
>");
  ...
  script_tag(name:"affected", value:"'Java 1.5.0' package(s) on SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Java 10 SP4, SUSE Linux Enterprise Desktop 10 SP4.");
