...
- CVE-2017-7697: Fixed a buffer overflow in calc_output_single.
 (bsc#1033564)");
  ...
  script_tag(name:"affected", value:"'libsamplerate' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
