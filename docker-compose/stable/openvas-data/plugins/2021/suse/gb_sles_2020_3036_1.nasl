...
Updated rails and puma dependencies for security fixes.");
  ...
  script_tag(name:"affected", value:"'rmt-server' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP2, SUSE Linux Enterprise Module for Public Cloud 15-SP2.");
