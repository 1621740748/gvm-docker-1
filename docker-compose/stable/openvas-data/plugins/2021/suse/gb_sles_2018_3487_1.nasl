...
CVE-2015-7543: Insecure creation of temporary directories allowed local
 ...
 (bsc#958347).");
  ...
  script_tag(name:"affected", value:"'kdelibs3' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
