...
- Include the finish location in tevent_req_default_print().");
  ...
  script_tag(name:"affected", value:"'samba, talloc, tevent' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise High Availability 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE Enterprise Storage 5.");
