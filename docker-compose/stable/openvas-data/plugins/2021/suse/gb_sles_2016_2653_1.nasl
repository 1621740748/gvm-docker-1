...
For a comprehensive list of changes please refer to the upstream change log: [link moved to references]");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Module for Web Scripting 12, SUSE Linux Enterprise Desktop 12-SP1.");
