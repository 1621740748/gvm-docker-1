...
CVE-2019-3813: Fixed a out-of-bounds read in the memslot_get_virt
 ...
 (bsc#1122706).");
  ...
  script_tag(name:"affected", value:"'spice' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 4.");
