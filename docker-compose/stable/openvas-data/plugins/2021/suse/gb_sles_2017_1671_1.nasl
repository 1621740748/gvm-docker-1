...
- CVE-2016-9082: fix a segfault when using >4GB images since int values
 were used for pointer operations (bsc#1007255).");
  ...
  script_tag(name:"affected", value:"'cairo' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
