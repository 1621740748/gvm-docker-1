...
* CVE-2015-5200: libvdpau: vulnerability in trace functionality
 (bnc#943969)");
  ...
  script_tag(name:"affected", value:"'libvdpau' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
