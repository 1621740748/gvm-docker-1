...
- Several vulnerabilities in standard conforming implementations of the
 ...
 CVE-2017-13088]");
  ...
  script_tag(name:"affected", value:"'wpa_supplicant' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP2.");
