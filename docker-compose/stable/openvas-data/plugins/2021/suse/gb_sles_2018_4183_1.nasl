...
CVE-2018-19873: Fixed Denial of Service on malformed BMP file in
 QBmpHandler (bsc#1118596)");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 4.");
