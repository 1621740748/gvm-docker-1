...
Fixed an issue in opencv-devel that broke builds with 'No rule to make
 target opencv_calib3d-NOTFOUND' (bsc#1154091).");
  ...
  script_tag(name:"affected", value:"'opencv' package(s) on SUSE Linux Enterprise Workstation Extension 15-SP2, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1.");
