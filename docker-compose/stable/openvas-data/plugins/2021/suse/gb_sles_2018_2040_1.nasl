...
- Add a check to Lib/wave.py that verifies that at least one channel is
 ...
 crafted wav format audio file. [bsc#1083507, CVE-2017-18207]");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE Enterprise Storage 5, SUSE CaaS Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
