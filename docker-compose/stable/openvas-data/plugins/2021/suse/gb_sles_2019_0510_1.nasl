...
CVE-2017-1000250: Fixed a information leak in SDP (part of the recently
 published BlueBorne vulnerabilities) (bsc#1057342)");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
