...
>");
  ...
  script_tag(name:"affected", value:"'Apache' package(s) on SUSE Linux Enterprise Software Development Kit 11 SP2, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Server 10 SP4, SLE SDK 10 SP4.");
