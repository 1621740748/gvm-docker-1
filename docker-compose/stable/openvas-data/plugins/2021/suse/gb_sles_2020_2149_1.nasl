...
Several other fixes for pg_dump, which ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'postgresql10 and postgresql12 ' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
