...
- Do not crash when the repository URL is not defined. (bsc#1043218)");
  ...
  script_tag(name:"affected", value:"'libzypp' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
