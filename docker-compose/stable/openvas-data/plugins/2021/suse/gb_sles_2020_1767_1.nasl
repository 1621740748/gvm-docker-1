...
CVE-2019-15666: Fixed an out of bounds read __xfrm_policy_unlink, which
 could have led to denial of service (bsc#1172140).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 31 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
