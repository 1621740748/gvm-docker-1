...
- bnc#907809: assert failure when processing wrapped strings
 (CVE-2014-9130)");
  ...
  script_tag(name:"affected", value:"'libyaml' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
