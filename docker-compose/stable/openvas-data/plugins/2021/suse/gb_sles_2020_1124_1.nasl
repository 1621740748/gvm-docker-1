...
aacraid blocks xen commands (bsc#1155200)");
  ...
  script_tag(name:"affected", value:"'xen' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
