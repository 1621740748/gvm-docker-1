...
Add new package for SLE-15. (jsc#ECO-1886)");
  ...
  script_tag(name:"affected", value:"'zstd' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise High Performance Computing 15.");
