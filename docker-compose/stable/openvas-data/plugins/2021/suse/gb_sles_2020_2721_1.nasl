...
Fixed an issue where the net command was unable to negotiate SMB2
 (bsc#1174120),");
  ...
  script_tag(name:"affected", value:"'samba' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 9, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise High Availability 12-SP4, SUSE Linux Enterprise High Availability 12-SP3, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
