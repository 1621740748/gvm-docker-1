...
- A bug in the HTTP Chunked Encoding code has been fixed that could have
 ...
 client or server code running libsoup (bsc#1052916, CVE-2017-2885).");
  ...
  script_tag(name:"affected", value:"'libsoup' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
