...
Fixed an issue with rendering animated gifs (QTBUG-55141).");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
