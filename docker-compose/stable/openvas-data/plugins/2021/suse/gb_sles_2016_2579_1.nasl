...
- Order sudo rules by the same logic used by the native LDAP support from
 sudo. (bsc#1002973)");
  ...
  script_tag(name:"affected", value:"'sssd' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
