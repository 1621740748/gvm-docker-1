...
Additionally, the package go1.10 has been added.");
  ...
  script_tag(name:"affected", value:"'containerd, docker and go' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Containers 15.");
