...
Moved libmariadb.pc from /usr/lib/pkgconfig to /usr/lib64/pkgconfig for
 x86_64 (bsc#1126088)");
  ...
  script_tag(name:"affected", value:"'mariadb, mariadb-connector-c' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud 9, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
