...
CVE-2020-7066: Fixed URL truncation get_headers() if the URL contains
 zero (\0) character (bsc#1168352).");
  ...
  script_tag(name:"affected", value:"'php7' package(s) on SUSE Linux Enterprise Module for Web Scripting 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1.");
