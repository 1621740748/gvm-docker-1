...
CVE-2019-20788: Fixed a integer overflow and heap-based buffer overflow
 via a large height or width value (bsc#1170441).");
  ...
  script_tag(name:"affected", value:"'LibVNCServer' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Point of Sale 11-SP3, SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP3.");
