...
'runc' package to match that we now ship the Docker fork of runc.");
  ...
  script_tag(name:"affected", value:"'Version update for docker, docker-runc, containerd, golang-github-docker-libnetwork' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Module for Containers 12.");
