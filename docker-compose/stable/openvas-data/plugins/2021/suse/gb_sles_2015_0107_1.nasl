...
- bnc#911228: Fix noglob patch, it broke files with space.");
  ...
  script_tag(name:"affected", value:"'rpm' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
