...
CVE-2018-19869: Fixed Denial of Service when parsing malformed URL
 reference (bsc#1118599)");
  ...
  script_tag(name:"affected", value:"'libqt5-qtsvg' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
