...
CVE-2019-8696: Fixed a stack buffer overflow in libcups's
 asn1_get_packed function (bsc#1146359).");
  ...
  script_tag(name:"affected", value:"'cups' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Basesystem 15.");
