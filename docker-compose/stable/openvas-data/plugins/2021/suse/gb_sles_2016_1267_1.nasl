...
- bsc#889013: Rename README.SuSE to the new spelling (bsc#889013)");
  ...
  script_tag(name:"affected", value:"'compat-openssl098' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Module for Legacy Software 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
