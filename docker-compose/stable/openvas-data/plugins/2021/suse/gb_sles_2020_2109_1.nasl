 ...
 * Remove '_if_needed' from RTSRoot._set_dbroot()'s name Replacing old
 tarball with python-rtslib-fb-v2.1.73.tar.xz");
  ...
  script_tag(name:"affected", value:"'python-rtslib-fb' package(s) on SUSE Linux Enterprise Module for Python2 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2.");
