...
CVE-2021-3472: XChangeFeedbackControl Integer Underflow Privilege
 Escalation (bsc#1180128)");
  ...
  script_tag(name:"affected", value:"'xorg-x11-server' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, HPE Helion Openstack 8.");
