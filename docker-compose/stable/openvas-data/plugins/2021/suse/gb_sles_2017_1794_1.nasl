...
- CVE-2017-7526: Hardening against a local side-channel attack in RSA key
 handling has been added (bsc#1046607)");
  ...
  script_tag(name:"affected", value:"'libgcrypt' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2, OpenStack Cloud Magnum Orchestration 7.");
