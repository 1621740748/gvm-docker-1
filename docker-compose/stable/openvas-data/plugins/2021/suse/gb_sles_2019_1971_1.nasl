...
CVE-2019-12904: Fixed a flush-and-reload side-channel attack in the AES
 implementation (bsc#1138939).");
  ...
  script_tag(name:"affected", value:"'libgcrypt' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
