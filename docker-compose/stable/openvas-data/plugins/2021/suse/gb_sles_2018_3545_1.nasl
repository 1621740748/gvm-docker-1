...
sanitize input and output channels on MPE profiles (bsc#1026650).");
  ...
  script_tag(name:"affected", value:"'lcms2' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
