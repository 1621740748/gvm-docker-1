...
CVE-2018-20622: Fix memory leak in jas_malloc.c (bsc#1120805).");
  ...
  script_tag(name:"affected", value:"'jasper' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Desktop Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
