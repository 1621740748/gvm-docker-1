...
Allow YaST to select Iranian (Persian, Farsi) keyboard layout
 (bsc#1092920)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Basesystem 15, SUSE Linux Enterprise High Performance Computing 15.");
