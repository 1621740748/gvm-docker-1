...
Fixed a denial-of-service condition from exponential explosion
 ...
 malicious SVGs.");
  ...
  script_tag(name:"affected", value:"'librsvg' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
