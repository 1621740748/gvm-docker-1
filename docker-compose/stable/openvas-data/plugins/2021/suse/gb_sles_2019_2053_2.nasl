...
CVE-2018-1000802: Fixed a command injection in the shutil module
 (bsc#1109663).");
  ...
  script_tag(name:"affected", value:"'python3' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE Linux Enterprise Server 12-SP3, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
