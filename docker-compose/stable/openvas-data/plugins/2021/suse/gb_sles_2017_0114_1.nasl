...
- CVE-2016-1000111: sets environmental variable HTTP_PROXY based on user
 supplied Proxy request header (bsc#989997)");
  ...
  script_tag(name:"affected", value:"'python-Twisted' package(s) on SUSE Linux Enterprise Module for Web Scripting 12, SUSE Enterprise Storage 4, SUSE Enterprise Storage 3.");
