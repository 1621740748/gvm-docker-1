...
Fixed an issue, whereby working with gRPC backends might result in
 excessive memory consumption.");
  ...
  script_tag(name:"affected", value:"'nginx' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15.");
