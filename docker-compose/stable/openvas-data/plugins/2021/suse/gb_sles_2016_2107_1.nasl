...
- Add patch to fix a buffer overflow in GECOS parser (bsc#992966
 CVE-2016-6318)");
  ...
  script_tag(name:"affected", value:"'cracklib' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
