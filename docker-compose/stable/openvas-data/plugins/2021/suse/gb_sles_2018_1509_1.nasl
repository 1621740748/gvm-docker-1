...
- bsc#1083125: Fixed kgraft: small race in reversion code");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 24 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1.");
