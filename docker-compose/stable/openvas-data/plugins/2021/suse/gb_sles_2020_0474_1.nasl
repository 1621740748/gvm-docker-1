...
Fixed a crash in BN_copy (bsc#1160163).");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 5, SUSE CaaS Platform 3.0, HPE Helion Openstack 8.");
