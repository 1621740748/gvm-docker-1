...
CVE-2021-29425: Limited path traversal when invoking the method
 FileNameUtils.normalize with an improper input string (bsc#1184755).");
  ...
  script_tag(name:"affected", value:"'apache-commons-io' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Server 12-SP5.");
