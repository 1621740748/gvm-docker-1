...
- CVE-2016-6911: Check for out-of-bound read in dynamicGetbuf()
 (bsc#1005274)");
  ...
  script_tag(name:"affected", value:"'gd' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
