...
- Don't try to import modules from current working directory (bsc#916835,
 CVE-2013-4245).");
  ...
  script_tag(name:"affected", value:"'orca' package(s) on SUSE Linux Enterprise Server for VMWare 11-SP3, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Desktop 11-SP3.");
