...
- Fix incomplete backporting of 'rcntp ntptimemset'.");
  ...
  script_tag(name:"affected", value:"'ntp' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
