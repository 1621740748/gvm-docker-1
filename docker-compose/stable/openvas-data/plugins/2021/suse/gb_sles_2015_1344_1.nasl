...
Also the DH parameters were increased to 2048 bit to fix logjam security issue (bsc#935856)");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
