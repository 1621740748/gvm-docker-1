...
Added explicit requires between libglib2 and libgio2 (bsc#1140122).");
  ...
  script_tag(name:"affected", value:"'glib2' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE Linux Enterprise Server 12-SP3, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
