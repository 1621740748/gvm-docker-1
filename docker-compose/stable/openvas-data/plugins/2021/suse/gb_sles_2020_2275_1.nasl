...
CVE-2019-20907: Avoid a possible infinite loop caused by specifically
 crafted tarballs (bsc#1174091).");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP5, SUSE Linux Enterprise Server 12-SP5, SUSE Enterprise Storage 5.");
