...
CVE-2018-16585: The .setdistillerkeys PostScript command was accepted
 ...
 after the startup phase). This lead to memory corruption, ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP3, SUSE Enterprise Storage 4.");
