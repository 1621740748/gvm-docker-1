...
- CVE-2017-7555: Fix a memory corruption bug could have lead to arbitrary
 ...
 parse_name() (bsc#1054171).");
  ...
  script_tag(name:"affected", value:"'augeas' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE CaaS Platform ALL.");
