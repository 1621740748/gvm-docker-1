...
>");
  ...
  script_tag(name:"affected", value:"'IBM Java' package(s) on SUSE Linux Enterprise Software Development Kit 11 SP3, SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Java 11 SP3.");
