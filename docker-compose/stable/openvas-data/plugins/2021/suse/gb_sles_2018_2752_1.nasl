...
Fix non-deterministic build failure due to missing
 JavaScriptCore/JSContextRef.h.");
  ...
  script_tag(name:"affected", value:"'webkit2gtk3' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
