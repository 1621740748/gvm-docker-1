...
- A crafted AVI file could have caused a floating point exception leading
 to DoS (bsc#1024076, CVE-2017-5837, bsc#1024079, CVE-2017-5844)");
  ...
  script_tag(name:"affected", value:"'gstreamer-0_10-plugins-base' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP2, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
