...
Fixed OS arch detection when RPM is not installed (bsc#1114197).");
  ...
  script_tag(name:"affected", value:"'salt' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
