...
CVE-2019-9928: Fixed a heap-based overflow in the rtsp connection parser
 (bsc#1133375).");
  ...
  script_tag(name:"affected", value:"'gstreamer-0_10-plugins-base' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
