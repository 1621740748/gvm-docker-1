...
bsc#1177211 (CVE-2020-26116) no longer allowing special characters in
 ...
 of HTTPConnection.putrequest in httplib, stopping injection of headers.");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Module for Python2 15-SP2, SUSE Linux Enterprise Module for Python2 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Desktop Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
