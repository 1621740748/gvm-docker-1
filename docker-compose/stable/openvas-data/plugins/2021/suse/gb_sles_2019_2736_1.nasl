...
Validate min/max value for target controls and rbd:user/tcmu-runner
 image controls (bsc#1140491)");
  ...
  script_tag(name:"affected", value:"'ceph, ceph-iscsi, ses-manual_en' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Enterprise Storage 6.");
