...
- Report missing/optional files as 'not found' rather than 'error'.
 (bsc#1047785)");
  ...
  script_tag(name:"affected", value:"'libzypp, zypper' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
