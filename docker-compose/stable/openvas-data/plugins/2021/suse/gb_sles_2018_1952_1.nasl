...
if(description)
{
  ...
  script_tag(name:"affected", value:"'Initial update for kernel-azure' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Public Cloud 15, SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise High Availability 15.");
