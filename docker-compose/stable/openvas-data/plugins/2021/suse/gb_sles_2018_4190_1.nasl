...
CVE-2018-19486: Fixed git that executed commands from the current
 ...
 (bsc#1117257).");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
