...
add/modify repo: Add options to tune the GPG check settings (bsc#1045735)");
  ...
  script_tag(name:"affected", value:"'libzypp, zypper' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE CaaS Platform ALL, SUSE CaaS Platform 3.0.");
