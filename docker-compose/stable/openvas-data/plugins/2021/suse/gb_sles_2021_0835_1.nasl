...
CVE-2020-1749: Fixed an issue in some networking protocols in IPsec,
 ...
 the data unencrypted (bsc#1165631).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 39 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
