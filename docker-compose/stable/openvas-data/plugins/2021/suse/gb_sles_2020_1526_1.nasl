...
Fixed multiple potential DoS issues in SLIRP, similar to CVE-2019-6778
 (bsc#1123156).");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
