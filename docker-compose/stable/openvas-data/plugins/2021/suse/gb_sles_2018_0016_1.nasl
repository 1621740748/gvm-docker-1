...
- CVE-2017-14632: Remote Code Execution upon freeing uninitialized memory
 in function vorbis_analysis_headerout(bsc#1059809)");
  ...
  script_tag(name:"affected", value:"'libvorbis' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
