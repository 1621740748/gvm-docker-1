...
CVE-2019-10214: Fixed missing enforcement of TLS connections
 (bsc#1144065).");
  ...
  script_tag(name:"affected", value:"'skopeo' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Server Applications 15.");
