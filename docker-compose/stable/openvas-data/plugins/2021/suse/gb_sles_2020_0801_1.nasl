...
CVE-2017-1000232: Fixed a double-free vulnerability in str2host.c
 (bsc#1068709).");
  ...
  script_tag(name:"affected", value:"'ldns' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
