...
- Btrfs: ensure deletion from pinned_chunks list is protected ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux Kernel' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Build System Kit 12.");
