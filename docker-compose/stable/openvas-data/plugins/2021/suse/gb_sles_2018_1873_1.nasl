...
- CVE-2017-9814: Fixed and out-of-bounds read in cairo-truetype-subset.c
 ...
 the size before memory allocation (bsc#1049092)");
  ...
  script_tag(name:"affected", value:"'cairo' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
