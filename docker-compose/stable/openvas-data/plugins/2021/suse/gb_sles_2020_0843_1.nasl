...
CVE-2019-15026: Fixed a stack-based buffer over-read (bsc#1149110).");
  ...
  script_tag(name:"affected", value:"'memcached' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4.");
