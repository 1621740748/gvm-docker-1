...
various GVariant parsing issues have been resolved (bsc#1111499)");
  ...
  script_tag(name:"affected", value:"'glib2' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
