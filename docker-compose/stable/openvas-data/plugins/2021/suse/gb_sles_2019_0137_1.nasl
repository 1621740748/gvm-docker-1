...
udev: Ignore the exit code of systemd-detect-virt for memory hot-add.
 ...
 not be set to online. (bsc#1076696)");
  ...
  script_tag(name:"affected", value:"'systemd' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
