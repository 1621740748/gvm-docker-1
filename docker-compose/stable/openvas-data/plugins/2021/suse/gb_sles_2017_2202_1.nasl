 ...
 * FR-AD-003 - Pass correct statement length into sqlite3_prepare[_v2]");
  ...
  script_tag(name:"affected", value:"'freeradius-server' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3.");
