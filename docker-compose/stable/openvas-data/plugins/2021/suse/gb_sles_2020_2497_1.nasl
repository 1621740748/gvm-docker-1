...
CVE-2019-14895: Fixed a heap-based buffer overflow in the Marvell WiFi
 driver (bsc#1173100).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 29 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3.");
