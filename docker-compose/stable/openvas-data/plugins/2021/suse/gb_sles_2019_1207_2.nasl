...
CVE-2018-14624: The lock controlling the error log was not correctly
 ...
 could have caused slapd to crash (bsc#1106699).");
  ...
  script_tag(name:"affected", value:"'389-ds' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1.");
