...
Features
 ...
 - Fixed a ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'cni, cni-plugins, conmon, fuse-overlayfs, podman' package(s) on SUSE Linux Enterprise Module for Public Cloud 15-SP1, SUSE Linux Enterprise Module for Containers 15-SP1.");
