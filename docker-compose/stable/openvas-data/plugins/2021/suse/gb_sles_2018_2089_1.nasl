...
- Ensure libgcrypt20-hmac and libgcrypt20 are installed in the correct
 order. (bsc#1090766)");
  ...
  script_tag(name:"affected", value:"'libgcrypt' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE CaaS Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
