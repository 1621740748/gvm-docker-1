...
-5069,CVE-2012-5071,CVE-2012-5084,CVE-2012-5079,CVE-2012-508 9");
  ...
  script_tag(name:"affected", value:"'IBM Java 1.5.0' package(s) on SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Java 10 SP4, SUSE Linux Enterprise Desktop 10 SP4.");
