...
- CVE-2018-7169: Fixed an privilege escalation in newgidmap, which allowed
 ...
 is allowed. (bsc#1081294)");
  ...
  script_tag(name:"affected", value:"'shadow' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP2, SUSE CaaS Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
