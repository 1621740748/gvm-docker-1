...
In order to improve spectre mitigation for s390x, add a new feature in
 ...
 (bsc#1107489).");
  ...
  script_tag(name:"affected", value:"'qemu' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
