...
- CVE-2017-14867: Git used unsafe Perl scripts to support subcommands such
 ...
 via shell metacharacters in a module name (bsc#1061041).");
  ...
  script_tag(name:"affected", value:"'git' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Container as a Service Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
