 ...
 * revoke mis-issued intermediate CAs from TURKTRUST.");
  ...
  script_tag(name:"affected", value:"'openssl-certs' package(s) on SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Desktop 11 SP3, SUSE Linux Enterprise Desktop 11 SP2.");
