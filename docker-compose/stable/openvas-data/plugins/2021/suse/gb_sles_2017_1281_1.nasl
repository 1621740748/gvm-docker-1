...
- CVE-2017-7308: The packet_set_ring function in net/packet/af_packet.c in
 ...
 (bsc#1030575, bsc#1031660).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 20 for SLE 12' package(s) on SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12.");
