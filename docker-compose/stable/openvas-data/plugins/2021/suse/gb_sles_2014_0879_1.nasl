 ...
 * CVE-2013-0149");
  ...
  script_tag(name:"affected", value:"'quagga' package(s) on SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Server 10 SP3.");
