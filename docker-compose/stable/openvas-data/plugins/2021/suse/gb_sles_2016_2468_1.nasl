...
* resume reading from /dev/urandom when interrupted by a signal
 (bsc#995075)");
  ...
  script_tag(name:"affected", value:"'compat-openssl098' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Module for Legacy Software 12, SUSE Linux Enterprise Desktop 12-SP1.");
