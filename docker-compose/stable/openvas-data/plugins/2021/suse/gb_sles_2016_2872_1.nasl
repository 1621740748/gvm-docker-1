...
- CVE-2014-6278: Code execution after original 6271 fix (bsc#898884)");
  ...
  script_tag(name:"affected", value:"'bash' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
