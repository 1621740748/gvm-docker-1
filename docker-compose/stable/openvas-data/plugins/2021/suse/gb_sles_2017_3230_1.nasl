...
- Test configuration before running daemon to prevent looping resulting in
 service shutdown (bsc#1048367)");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP2, SUSE Container as a Service Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
