...
- CVE-2013-7446: Use-after-free vulnerability in net/unix/af_unix.c in the
 ...
 calls (bsc#973570, bsc#955837).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel Live Patch 9 for SLE 12' package(s) on SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12.");
