...
The Mozilla NSPR library was updated to version 4.10.9, fixing various bugs.");
  ...
  script_tag(name:"affected", value:"'MozillaFirefox, mozilla-nspr' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
