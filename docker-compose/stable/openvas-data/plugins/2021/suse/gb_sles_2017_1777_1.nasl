...
- Cannot create table radpostauth because of deprecated TIMESTAMP(14)
 syntax. (bsc#912873)");
  ...
  script_tag(name:"affected", value:"'freeradius-server' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
