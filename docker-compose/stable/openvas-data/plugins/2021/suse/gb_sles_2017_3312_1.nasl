...
- CVE-2017-10661: Race condition in fs/timerfd.c allowed local users to
 ...
 leverage improper might_cancel queueing (bsc#1053153).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 16 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1.");
