...
- Directory traversal vulnerability in the read_long_names function
 (CVE-2014-9447).");
  ...
  script_tag(name:"affected", value:"'elfutils' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
