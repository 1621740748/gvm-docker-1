...
Update to 1.1.1d (bsc#1133925, jsc#SLE-6430).");
  ...
  script_tag(name:"affected", value:"'openssl-1_1' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Desktop 12-SP4.");
