...
- Disable DH parameters under 2048 bits by default and allow lowering the
 ...
 (bsc#932483, bsc#948902)");
  ...
  script_tag(name:"affected", value:"'openssh' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
