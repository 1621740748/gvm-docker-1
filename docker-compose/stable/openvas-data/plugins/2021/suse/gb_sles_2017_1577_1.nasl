...
- Make libqt5-qtquickcontrols available in SUSE Linux Enterprise.");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase, libqt5-qtdeclarative' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
