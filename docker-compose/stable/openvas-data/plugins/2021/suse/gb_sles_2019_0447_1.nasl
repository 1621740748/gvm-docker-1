...
Fix krita pop-up palette not working properly (bsc#1120639)");
  ...
  script_tag(name:"affected", value:"'libqt5-qtbase' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
