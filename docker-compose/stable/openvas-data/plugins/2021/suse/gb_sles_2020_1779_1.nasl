...
CVE-2020-1749: Fixed an issue where some ipv6 protocols were not
 encrypted over ipsec tunnel (bsc#1165631).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 31 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3.");
