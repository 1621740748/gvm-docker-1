...
- CVE-2016-10396: The racoon daemon contained a remotely exploitable
 ...
 packets in a particular order (bsc#1047443).");
  ...
  script_tag(name:"affected", value:"'ipsec-tools' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
