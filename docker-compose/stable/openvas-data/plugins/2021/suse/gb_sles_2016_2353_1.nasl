...
- Improve message for creating volumes with a filesystem but without a
 mount point. (bsc#996208)");
  ...
  script_tag(name:"affected", value:"'yast2-storage' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
