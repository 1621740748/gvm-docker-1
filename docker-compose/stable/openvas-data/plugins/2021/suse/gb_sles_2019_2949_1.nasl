...
CVE-2019-15291: Fixed a NULL pointer dereference issue that could be
 caused by a malicious USB device ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux Kernel' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise High Availability 12-SP3, SUSE Enterprise Storage 5, SUSE CaaS Platform 3.0, HPE Helion Openstack 8.");
