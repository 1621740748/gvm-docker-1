...
- CVE-2018-1000004: Prevent race condition in the sound system that could
 have lead to a deadlock and denial of service condition (bsc#1076017).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 17 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2.");
