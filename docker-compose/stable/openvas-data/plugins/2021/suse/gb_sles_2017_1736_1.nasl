...
- An attacker who with the ability to send and receive messages to an
 ...
 accepting an unauthorized dynamic update. [bsc#1046555, CVE-2017-3143]");
  ...
  script_tag(name:"affected", value:"'bind' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP2.");
