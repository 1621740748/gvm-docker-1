...
CVE-2020-1938: Fixed a file contents disclosure vulnerability
 (bsc#1164692).");
  ...
  script_tag(name:"affected", value:"'tomcat' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15.");
