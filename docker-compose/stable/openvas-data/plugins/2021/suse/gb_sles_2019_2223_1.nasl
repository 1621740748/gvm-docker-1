...
Fixed a bug where Podman could not run containers ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'podman, slirp4netns and libcontainers-common' package(s) on SUSE Linux Enterprise Module for Containers 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
