...
Added explicit requires between libglib2 and libgio2 (bsc#1140122).");
  ...
  script_tag(name:"affected", value:"'glib2' package(s) on SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Workstation Extension 12-SP5, SUSE Linux Enterprise Workstation Extension 12-SP4, SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP5, SUSE Linux Enterprise Desktop 12-SP4, SUSE Enterprise Storage 5, SUSE Enterprise Storage 4, SUSE CaaS Platform 3.0.");
