...
CVE-2018-16427: Fixed out of bounds reads when handling responses in
 OpenSC (bsc#1107033)");
  ...
  script_tag(name:"affected", value:"'opensc' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
