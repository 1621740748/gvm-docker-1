...
CVE-2018-1000135: A potential leak of private DNS queries to other DNS
 servers could happen while on VPN (bsc#1086263, bgo#746422).");
  ...
  script_tag(name:"affected", value:"'NetworkManager' package(s) on SUSE Linux Enterprise Workstation Extension 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
