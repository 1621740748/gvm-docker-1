...
- The telnet 'vty' CLI of the Quagga daemon is no longer enabled by
 ...
 password. [bsc#1021669]");
  ...
  script_tag(name:"affected", value:"'quagga' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
