...
(bsc#1122033)
 ...
 Depending on your local needs install either one of them. The default is the -SUSE configuration.");
  ...
  script_tag(name:"affected", value:"'ImageMagick' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15.");
