...
if(description)
{
  ...
  script_tag(name:"affected", value:"'coreutils' package(s) on SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Desktop 11 SP3, SUSE Linux Enterprise Desktop 11 SP2.");
