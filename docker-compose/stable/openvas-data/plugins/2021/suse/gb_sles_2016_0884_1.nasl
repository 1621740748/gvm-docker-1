...
- fix a crash in mutex handling (bsc#963017)");
  ...
  script_tag(name:"affected", value:"'ghostscript' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
