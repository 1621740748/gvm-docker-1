...
Fixed an issue in TLS-EAP where the OCSP verification, when an
 intermediate client certificate was not explicitly trusted (bsc#1146848).");
  ...
  script_tag(name:"affected", value:"'freeradius-server' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise High Performance Computing 15.");
