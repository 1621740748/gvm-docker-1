...
- CVE-2015-8075: Fixed heap overflow issue (bsc#953519).");
  ...
  script_tag(name:"affected", value:"'libsndfile' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Desktop 12-SP1.");
