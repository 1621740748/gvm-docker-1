 ...
 * Add l-qclipboard_delay.patch (QTBUG-38585)");
  ...
  script_tag(name:"affected", value:"'libqt4' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
