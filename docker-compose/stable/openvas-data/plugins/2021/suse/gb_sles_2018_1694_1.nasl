...
- CVE-2017-14604: Fixed a file type spoofing attack by adding a
 ...
 file (bsc#1060031).");
  ...
  script_tag(name:"affected", value:"'nautilus' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
