...
For a comprehensive list of changes please refer to the package's change log or the Release Notes at [link moved to references]");
  ...
  script_tag(name:"affected", value:"'python-requests' package(s) on SUSE OpenStack Cloud Compute 5, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Linux Enterprise High Availability 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Enterprise Storage 2, SUSE Enterprise Storage 1.0.");
