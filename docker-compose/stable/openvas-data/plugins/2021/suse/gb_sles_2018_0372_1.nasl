...
- Implement endian swapping, required for big-endian guests to connect to
 the spice client successfully. (bsc#1012215)");
  ...
  script_tag(name:"affected", value:"'spice-vdagent' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP2.");
