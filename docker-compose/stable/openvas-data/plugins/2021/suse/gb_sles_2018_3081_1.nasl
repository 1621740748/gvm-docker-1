...
CVE-2017-18258: The xz_head function allowed remote attackers to cause a
 ...
 required for a legitimate file (bsc#1088601).");
  ...
  script_tag(name:"affected", value:"'libxml2' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3, SUSE CaaS Platform ALL, SUSE CaaS Platform 3.0, OpenStack Cloud Magnum Orchestration 7.");
