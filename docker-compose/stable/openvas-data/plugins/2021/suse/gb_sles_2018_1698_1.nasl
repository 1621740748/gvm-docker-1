...
- CVE-2018-12020: GnuPG mishandled the original filename during decryption
 ...
 option (bsc#1096745)");
  ...
  script_tag(name:"affected", value:"'gpg2' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP3, SUSE Enterprise Storage 4, SUSE CaaS Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
