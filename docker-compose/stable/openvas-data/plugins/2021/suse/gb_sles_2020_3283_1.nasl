...
and CVE-2020-10648 (bsc#1167209)");
  ...
  script_tag(name:"affected", value:"'u-boot' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise High Performance Computing 15.");
