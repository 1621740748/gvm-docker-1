...
Use SHA-2 in the RSA pairwise consistency check (bsc#1155346).");
  ...
  script_tag(name:"affected", value:"'openssl-1_1' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
