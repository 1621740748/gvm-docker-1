...
CVE-2018-18520: Fixed bad handling of ar files inside are files
 (bsc#1112726).");
  ...
  script_tag(name:"affected", value:"'elfutils' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP4, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Desktop 12-SP3, SUSE CaaS Platform 3.0, OpenStack Cloud Magnum Orchestration 7.");
