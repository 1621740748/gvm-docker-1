...
CVE-2020-1971: Fixed a null pointer dereference in EDIPARTYNAME
 (bsc#1179491).");
  ...
  script_tag(name:"affected", value:"'openssl' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
