...
CVE-2019-9937: Fixed a denial of service related to interleaving reads
 ...
 (bsc#1130325).");
  ...
  script_tag(name:"affected", value:"'sqlite3' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
