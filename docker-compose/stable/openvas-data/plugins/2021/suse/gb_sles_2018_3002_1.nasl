...
CVE-2018-1000802: Prevent command injection in shutil module
 ...
 (bsc#1109663)");
  ...
  script_tag(name:"affected", value:"'python' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
