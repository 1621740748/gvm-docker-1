...
Fixed an issue which was causing system hang during the load of gdm
 (bsc#1112578).");
  ...
  script_tag(name:"affected", value:"'gdm' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Desktop Applications 15.");
