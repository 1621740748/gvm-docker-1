...
- CVE-2017-5834: Maliciou crafted file could cause a heap buffer overflow
 or segmentation fault (bsc#1023848)");
  ...
  script_tag(name:"affected", value:"'libplist' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP2, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
