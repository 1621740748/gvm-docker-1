...
- CVE-2015-1283: Fix multiple integer overflows. (bnc#980391)");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on SUSE Studio Onsite 1.3, SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
