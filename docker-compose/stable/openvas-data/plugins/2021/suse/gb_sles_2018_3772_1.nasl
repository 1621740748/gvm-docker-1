...
CVE-2018-18386: The drivers/tty/n_tty.c allowed local attackers (who are
 ...
 TIOCINQ (bsc#1112039).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 32 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
