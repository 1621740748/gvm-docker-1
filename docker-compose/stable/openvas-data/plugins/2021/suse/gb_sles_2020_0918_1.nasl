...
CVE-2020-0556: Fixed an improper access control which could have allowed
 ...
 and denial of service (bsc#1166751).");
  ...
  script_tag(name:"affected", value:"'bluez' package(s) on SUSE Linux Enterprise Workstation Extension 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Desktop Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
