...
if(description)
{
 ...
 (bsc#1089638).");
  ...
  script_tag(name:"affected", value:"'dpdk-thunderxdpdk' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3.");
