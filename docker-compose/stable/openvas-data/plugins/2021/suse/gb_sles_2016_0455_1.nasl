...
- CVE-2015-8805: Fixed miscomputation bugs in secp-256r1 modulo functions.
 (bsc#964849)");
  ...
  script_tag(name:"affected", value:"'libnettle' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12.");
