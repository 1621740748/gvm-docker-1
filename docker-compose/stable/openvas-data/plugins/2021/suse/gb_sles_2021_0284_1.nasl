...
CVE-2020-27827: Fixed a memory leak when parsing lldp packets
 ...
 openvswitch.rpm file in order to obtain a list of all changes.");
  ...
  script_tag(name:"affected", value:"'openvswitch' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
