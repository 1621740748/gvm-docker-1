...
Fixes bash completion option detection (bsc#1049825)");
  ...
  script_tag(name:"affected", value:"'libsolv, libzypp, zypper' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP4, SUSE Enterprise Storage 5, SUSE Enterprise Storage 4, SUSE CaaS Platform 3.0, HPE Helion Openstack 8.");
