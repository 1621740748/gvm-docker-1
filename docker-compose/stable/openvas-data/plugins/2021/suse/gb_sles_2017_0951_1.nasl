...
- Fix /sbin/installkernel to handle kernel packages built with 'make
 bin-rpmpkg'. (bsc#1008648)");
  ...
  script_tag(name:"affected", value:"'dracut' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2, OpenStack Cloud Magnum Orchestration 7.");
