...
- lttng-modules");
  ...
  script_tag(name:"affected", value:"'oracleasm kmp' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise High Availability 12-SP3.");
