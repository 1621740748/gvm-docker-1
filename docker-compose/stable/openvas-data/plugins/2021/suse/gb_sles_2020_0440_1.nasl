...
Improves re-try logic to handle errors while downloading extensions");
  ...
  script_tag(name:"affected", value:"'python-azure-agent' package(s) on SUSE Linux Enterprise Module for Public Cloud 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1.");
