...
CVE-2019-9924: Fixed a vulnerability in which shell did not prevent user
 ...
 of the shell (bsc#1130324).");
  ...
  script_tag(name:"affected", value:"'bash' package(s) on SUSE OpenStack Cloud 7, SUSE Linux Enterprise Workstation Extension 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Enterprise Storage 4.");
