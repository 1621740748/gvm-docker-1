...
CVE-2019-15903: Fixed heap-based buffer over-read caused by crafted XML
 input. (bsc#1149429)");
  ...
  script_tag(name:"affected", value:"'expat' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Basesystem 15.");
