...
- CVE-2016-6252: Fixed incorrect integer handling that could results in a
 local privilege escalation (bsc#1099310)");
  ...
  script_tag(name:"affected", value:"'shadow' package(s) on SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
