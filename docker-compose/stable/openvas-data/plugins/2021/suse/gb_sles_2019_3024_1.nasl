...
CVE-2019-14859: Fixed a signature malleability caused by insufficient
 checks of DER encoding (bsc#1154217).");
  ...
  script_tag(name:"affected", value:"'python-ecdsa' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 9, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Manager Server 3.2, SUSE Linux Enterprise Module for Public Cloud 12, SUSE CaaS Platform 3.0, HPE Helion Openstack 8.");
