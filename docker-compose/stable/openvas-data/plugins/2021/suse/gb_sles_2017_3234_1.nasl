...
- CVE-2017-16853: Fix the DynamicMetadataProvider class to properly
 ...
 attacks (bsc#1068685).");
  ...
  script_tag(name:"affected", value:"'opensaml' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
