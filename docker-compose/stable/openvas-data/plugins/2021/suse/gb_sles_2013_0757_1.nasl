...
Also a slowness in 'convert' when resizing JPEG images has been addressed (bnc#754481).");
  ...
  script_tag(name:"affected", value:"'ImageMagick' package(s) on SUSE Linux Enterprise Software Development Kit 11 SP2, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Desktop 11 SP2.");
