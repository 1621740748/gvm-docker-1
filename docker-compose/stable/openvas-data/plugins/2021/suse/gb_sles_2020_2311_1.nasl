...
Solve a crash in mod_proxy_uwsgi for empty values of environment
 variables. (bsc#1174052)");
  ...
  script_tag(name:"affected", value:"'apache2' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP2.");
