...
CVE-2017-18234: Prevent use-after-free that allowed remote attackers to
 ...
 a .pdf file containing JPEG data (bsc#1085585).");
  ...
  script_tag(name:"affected", value:"'exempi' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
