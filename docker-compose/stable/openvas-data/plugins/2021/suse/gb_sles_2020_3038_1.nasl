...
libxl: Fixed lock manager lock ordering (bsc#1171701).");
  ...
  script_tag(name:"affected", value:"'libvirt' package(s) on SUSE OpenStack Cloud Crowbar 9, SUSE OpenStack Cloud 9, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server 12-SP4.");
