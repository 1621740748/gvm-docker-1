...
CVE-2018-8975: The pm_mallocarray2 function allowed remote attackers to
 ...
 image file (bsc#1086777).");
  ...
  script_tag(name:"affected", value:"'netpbm' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
