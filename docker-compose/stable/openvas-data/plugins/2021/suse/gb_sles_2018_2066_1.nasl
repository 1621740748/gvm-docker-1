...
- CVE-2018-7738: Fix local vulnerability using embedded shell commands in
 a mountpoint name (bsc#1084300)");
  ...
  script_tag(name:"affected", value:"'util-linux' package(s) on SUSE Linux Enterprise Module for Server Applications 15, SUSE Linux Enterprise Module for Basesystem 15.");
