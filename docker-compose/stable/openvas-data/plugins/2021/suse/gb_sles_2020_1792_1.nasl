...
Add ca-certificates (and ca-certificates-mozilla) to dependencies,
 otherwise https connections will fail.");
  ...
  script_tag(name:"affected", value:"'python3-requests' package(s) on SUSE OpenStack Cloud Crowbar 8, SUSE OpenStack Cloud 8, SUSE OpenStack Cloud 7, SUSE Manager Server 3.2, SUSE Manager Proxy 3.2, SUSE Linux Enterprise Workstation Extension 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Enterprise Storage 5, HPE Helion Openstack 8.");
