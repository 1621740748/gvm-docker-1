...
* CVE-2016-7445: Null pointer dereference in convert.c could lead to crash
 [bsc#999817]");
  ...
  script_tag(name:"affected", value:"'openjpeg2' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
