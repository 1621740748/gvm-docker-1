 ...
 * patches.suse/stack-unwind: Fix more 2.6.29 ... [Please see the references for more information on the vulnerabilities]");
  ...
  script_tag(name:"affected", value:"'Linux Kernel' package(s) on SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise High Availability Extension 11 SP1, SUSE Linux Enterprise Desktop 11 SP1.");
