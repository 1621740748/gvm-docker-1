...
* CVE-2015-0492: JavaFX: unauthenticated remote attackers could execute
 arbitrary code via multiple protocols.");
  ...
  script_tag(name:"affected", value:"'java-1_7_0-openjdk, java-1_7_0-openjdk-bootstrap' package(s) on SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
