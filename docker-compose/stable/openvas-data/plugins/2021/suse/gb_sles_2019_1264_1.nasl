...
Revert golang(API) removal since it turns out this breaks >= requires in
 certain cases (bsc#1114209).");
  ...
  script_tag(name:"affected", value:"'containerd, docker, docker-runc, go, go1.11, go1.12, golang-github-docker-libnetwork' package(s) on SUSE Linux Enterprise Module for Containers 12, SUSE CaaS Platform 3.0, OpenStack Cloud Magnum Orchestration 7.");
