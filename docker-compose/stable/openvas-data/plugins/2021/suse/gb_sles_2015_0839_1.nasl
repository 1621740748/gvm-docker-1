...
* CVE-2014-2978: Remote attackers could cause a denial of service (crash)
 ...
 triggers an out-of-bounds write.");
  ...
  script_tag(name:"affected", value:"'DirectFB' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
