...
- Fix a stack overflow in the parser that could have been leveraged to
 execute arbitrary code (bsc#964844)");
  ...
  script_tag(name:"affected", value:"'socat' package(s) on SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Debuginfo 11-SP4.");
