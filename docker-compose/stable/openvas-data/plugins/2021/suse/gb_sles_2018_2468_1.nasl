...
This updates also sets the permissions of already existing log files to proper values.");
  ...
  script_tag(name:"affected", value:"'libcgroup' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
