...
- Speed up YAML syntax highlighting (bsc#1018870)");
  ...
  script_tag(name:"affected", value:"'vim' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2, OpenStack Cloud Magnum Orchestration 7.");
