...
- Enable tests to run during the build. This way we can compare the
 results on different builds.");
  ...
  script_tag(name:"affected", value:"'ruby2.1' package(s) on SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
