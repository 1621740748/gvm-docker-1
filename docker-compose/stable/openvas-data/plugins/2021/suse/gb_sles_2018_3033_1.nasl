...
CVE-2018-17407: Prevent buffer overflow when handling of Type 1 fonts
 ...
 of the vulnerable tools: pdflatex, pdftex, dvips, or luatex (bsc#1109673)");
  ...
  script_tag(name:"affected", value:"'texlive' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Desktop 12-SP3.");
