...
Additional upstream bug fixes (bsc#1027519)");
  ...
  script_tag(name:"affected", value:"'xen' package(s) on SUSE Linux Enterprise Module for Server Applications 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1.");
