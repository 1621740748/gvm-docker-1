...
CVE-2019-15606: Fixed the white space sanitation of HTTP headers
 (CVE-2019-15606, bsc#1163103).");
  ...
  script_tag(name:"affected", value:"'nodejs10' package(s) on SUSE Linux Enterprise Server for SAP 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Module for Web Scripting 15-SP1, SUSE Linux Enterprise Module for Web Scripting 15, SUSE Linux Enterprise High Performance Computing 15.");
