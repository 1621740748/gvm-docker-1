...
CVE-2020-1749: A flaw was found in the implementation of some networking
 ...
 endpoints to read the traffic unencrypted. (bsc#1165629)");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 35 for SLE 12 SP3)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
