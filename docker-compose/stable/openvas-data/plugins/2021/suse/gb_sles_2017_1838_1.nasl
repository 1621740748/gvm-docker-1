...
- Address read of 4 bytes past the end of buffer in OpenPGP certificate
 parsing (bsc#1038337)");
  ...
  script_tag(name:"affected", value:"'gnutls' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP2.");
