...
Fixed a denial-of-service condition from exponential explosion
 ...
 malicious SVGs.");
  ...
  script_tag(name:"affected", value:"'librsvg' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1.");
