...
Fixed warning about deprecated regex during sa-update (bsc#1069831)");
  ...
  script_tag(name:"affected", value:"'spamassassin' package(s) on SUSE Linux Enterprise Module for Development Tools 15, SUSE Linux Enterprise Module for Basesystem 15.");
