...
- Link the 'system_group' plugin with sudo_util library to resolve the
 missing sudo_dso_findsym symbol (bsc#1034560)");
  ...
  script_tag(name:"affected", value:"'sudo' package(s) on SUSE OpenStack Cloud 6, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12.");
