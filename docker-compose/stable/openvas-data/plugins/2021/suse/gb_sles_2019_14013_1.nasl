...
CVE-2019-9641: Fixed multiple invalid memory access in EXIF extension
 ...
 of rename function (bsc#1128722).");
  ...
  script_tag(name:"affected", value:"'php53' package(s) on SUSE Linux Enterprise Software Development Kit 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Point of Sale 11-SP3, SUSE Linux Enterprise Debuginfo 11-SP4.");
