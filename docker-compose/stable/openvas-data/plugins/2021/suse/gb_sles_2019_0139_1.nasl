...
bsc#1074247: Fix test suite, use correct date (gh#shazow/urllib3#1303).");
  ...
  script_tag(name:"affected", value:"'python-urllib3' package(s) on SUSE Manager Server 3.2, SUSE Manager Server 3.1, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Enterprise Storage 5, SUSE Enterprise Storage 4, SUSE CaaS Platform ALL, SUSE CaaS Platform 3.0, OpenStack Cloud Magnum Orchestration 7.");
