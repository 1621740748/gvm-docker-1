...
CVE-2018-11439: The TagLib::Ogg::FLAC::File::scan function allowed
 ...
 over-read) via a crafted audio file (bsc#1096180).");
  ...
  script_tag(name:"affected", value:"'taglib' package(s) on SUSE Linux Enterprise Workstation Extension 12-SP5, SUSE Linux Enterprise Software Development Kit 12-SP5, SUSE Linux Enterprise Server 12-SP5.");
