...
- Ensure -X flag works even when setting owner/group (bsc#1028842)");
  ...
  script_tag(name:"affected", value:"'rsync' package(s) on SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Desktop 12-SP2, SUSE CaaS Platform ALL, OpenStack Cloud Magnum Orchestration 7.");
