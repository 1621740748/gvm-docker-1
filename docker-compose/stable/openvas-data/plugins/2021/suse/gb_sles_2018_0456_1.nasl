...
- The Quagga BGP daemon could have entered an infinite loop if sent an
 ...
 restarted. [CVE-2018-5381, bsc#1079801]");
  ...
  script_tag(name:"affected", value:"'quagga' package(s) on SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2.");
