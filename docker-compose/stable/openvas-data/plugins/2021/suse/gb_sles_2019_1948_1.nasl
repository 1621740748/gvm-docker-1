...
This update contains a regression fix for CVE-2019-11477 and CVE-2019-11478 (bsc#1140747).");
  ...
  script_tag(name:"affected", value:"'Linux Kernel (Live Patch 28 for SLE 12 SP2)' package(s) on SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Live Patching 12-SP4.");
