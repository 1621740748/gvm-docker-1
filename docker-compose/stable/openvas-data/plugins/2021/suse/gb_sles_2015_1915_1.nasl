...
* CVE-2015-5214: Multiple Vendor LibreOffice Bookmark Status Memory
 ...
 execute code as the user opening the document.");
  ...
  script_tag(name:"affected", value:"'LibreOffice' package(s) on SUSE Linux Enterprise Workstation Extension 12, SUSE Linux Enterprise Software Development Kit 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Desktop 12.");
